...
/*{{<exclude_fglue>
                    ...
                    TecUtilDataNodeSectionGetRawPtrByRef
                    TecUtilDataNodeSectionGetRawPtrByRef64
 ...
 *
 */
LINKTOADDON int32_t TecUtilImportGetLoaderInstrCount();
 ...
 *
 */
LINKTOADDON void TecUtilImportGetLoaderInstrByNum(int32_t                 Index,
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilFieldLayerIsActiveForFrame(UniqueID_t   FrameID,
                                                                                const char *LayerShowFlag) TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilFieldLayerIsActive(const char *LayerShowFlag) TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilLinePlotLayerIsActiveForFrame(UniqueID_t FrameID,
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilLinePlotLayerIsActive(const char *LayerShowFlag);
 ...
 */
LINKTOADDON ArbParam_t TecUtilFrameGetLinking(const char *Attribute);
 ...
 *
 */
LINKTOADDON ArbParam_t TecUtilLinkingGetValue(const char *Attribute,
 ...
 *
 */
LINKTOADDON void TecUtilWorkAreaGetDimensions(TP_OUT int32_t* Width,
 ...
 *
 */
LINKTOADDON void TecUtilPaperGetDimensions(TP_OUT double* Width,
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilViewGetMagnification(TP_OUT double* Magnification);
 ...
 * @endcode
 *
 * @sa TecUtilBlankingIsNonDepthActive
 *
 * @ingroup Blanking
 *
 * @since 11.3-17-015
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilBlankingIsActive() TP_DIRECT;


/**
 * Determine if non-depth blanking is active (i.e. if IJK or Value blanking are active).
 * Use this instead of TecUtilBlankingIsActive() if you want to know ahead of time if
 * calling TecUtilBlankingCheckDataPoint, TecUtilBlankingCheckFECell, or TecUtilBlankingCheckIJKCell
 * has the potential of being fruitful or not as these functions do not consider depth blanking.
 *
 * @return
 *   TRUE if non-depth blanking is active.
 *
 * @pre Must have one or more frames.
 *
 *
 * <FortranSyntax>
 *    INTEGER*4 FUNCTION TecUtilBlankingIsNonDepthActive()
 * </FortranSyntax>
 *
 * <PythonSyntax>
 * </PythonSyntax>
 *
 * @code
 *   Boolean_t BlankingIsActive = TecUtilBlankingIsNonDepthActive();
 * @endcode
 *
 * @sa TecUtilBlankingIsActive
 *
 * @ingroup Blanking
 *
 * @since 2020.1
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilBlankingIsNonDepthActive();
 ...
 *
 * @return
 *   TRUE if the data point is visible, FALSE if it is blanked or if the zone metrics could not be
 *   loaded.
 *
 * @pre Must have one or more frames.
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilBlankingCheckDataPoint(EntIndex_t Zone,
 ...
 *
 * @param section
 *   The section containing the element of interest.
 *
 * @param cellIndex
 *   The index of the element of interest within the section.
 *
 * @return
 *   TRUE if the element is visible, FALSE if it is blanked or the zone metrics couldn't be loaded.
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilBlankingCheckFEElem(
    EntIndex_t zone,
    EntIndex_t section,
    LgIndex_t cellIndex);
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilBlankingCheckFECell(
    EntIndex_t zone,
    LgIndex_t  cellIndex);
 ...
 *
 * @return
 *   TRUE if the cell is visible, FALSE if it is blanked or if the zone metrics could not be loaded.
 *   NOTE: This function will return FALSE if the SDK is in an interrupted state. In that case the FALSE return
 *   value does not necessarily indicate that the cell is blanked. It is recommended that SDK clients call
 *   @ref TecUtilInterruptCheck() before calling this function, and not call this function if SDK is in an
 *   interrupted state.
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilBlankingCheckIJKCell(EntIndex_t  Zone,
 ...
 *
 */
LINKTOADDON int32_t TecUtilLockGetCount() TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilLockIsOn() TP_DIRECT;
 ...
 *
 */
LINKTOADDON int32_t TecUtilPageGetCount() TP_DIRECT;
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilPageGetName(TP_GIVES char** PageName) TP_DIRECT;
 ...
 *
 */
LINKTOADDON UniqueID_t TecUtilPageGetUniqueID() TP_DIRECT;
 ...
 * @ingroup PageManagement
 */
LINKTOADDON int32_t TecUtilPageGetPosByUniqueID(UniqueID_t UniqueID) TP_DIRECT;
 ...
 * #internalattributes exclude_python, exclude_sdkdoc
 */
LINKTOADDON int32_t TecUtilGetTecplotVersion() TP_DIRECT;
 ...
 *     The next unique ID.
 */
LINKTOADDON UniqueID_t TecUtilGetNextUniqueID() TP_DIRECT;
 ...
 *
 */
LINKTOADDON int32_t TecUtilTecplotGetMajorVersion() TP_DIRECT;
 ...
 *
 */
LINKTOADDON int32_t TecUtilTecplotGetMinorVersion() TP_DIRECT;
 ...
 *
 */
LINKTOADDON int32_t TecUtilTecplotGetMajorRevision() TP_DIRECT;
 ...
 *
 */
LINKTOADDON int32_t TecUtilTecplotGetMinorRevision() TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_GIVES char* TecUtilTecplotGetHomeDirectory();
 ...
 *
 */
LINKTOADDON TP_GIVES char* TecUtilTecplotGetExePath();
 ...
 */
LINKTOADDON TP_GIVES char* TecUtilAddOnGetPath(AddOn_pa AddOnID);
 ...
 *
 */
LINKTOADDON int32_t TecUtilFrameGetCount() TP_DIRECT;
 ...
 * #internalattributes exclude_python, exclude_sdkdoc
 */
LINKTOADDON FrameMode_e TecUtilFrameGetMode() TP_DIRECT;
 ...
 *
 */
LINKTOADDON PlotType_e TecUtilFrameGetPlotTypeForFrame(UniqueID_t FrameID) TP_DIRECT;
 ...
 *
 */
LINKTOADDON PlotType_e TecUtilFrameGetPlotType() TP_DIRECT;

/**
 * Indicates if the active frame is managing transient data.
 *
 * @since 18.3
 *
 * @return
 *     TRUE if the active frame is managing transient data, FALSE otherwise.
 *
 * @ingroup FrameManagement
 */
LINKTOADDON Boolean_t TecUtilFrameManagesTransientData() TP_DIRECT;
 ...
 *
 */
LINKTOADDON int32_t TecUtilPickListGetCount() TP_DIRECT;
 ...
 *
 */
LINKTOADDON PickObjects_e TecUtilPickListGetType(int32_t PickListIndex) TP_DIRECT;
 ...
 *
 */
LINKTOADDON int32_t TecUtilPickListGetLabelsContourGroup(int32_t PickListIndex);
 ...
 *
 */
LINKTOADDON int32_t TecUtilPickListGetLegendContourGroup(int32_t PickListIndex);
 ...
 *
 */
LINKTOADDON TP_GIVES char* TecUtilPickListGetFrameName(int32_t PickListIndex);
 ...
 *
 */
LINKTOADDON UniqueID_t TecUtilPickListGetFrameUniqueID(int32_t PickListIndex);
 ...
 * @ingroup FrameManagement
 */
LINKTOADDON void TecUtilGetBoundingBoxOfAllFrames(TP_OUT double* X1,
                                                          TP_OUT double* Y1,
                                                          TP_OUT double* X2,
                                                          TP_OUT double* Y2);
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilAxisGetGridRange(TP_OUT double* AxisGridXMin,
 ...
 *
 */
LINKTOADDON void TecUtilAxisGetRange(char           Axis,
                                             int32_t        AxisNum,
 ...
 * @ingroup Axis
 */
LINKTOADDON void TecUtilAxisGetVarAssignments(TP_OUT EntIndex_t* XOrThetaVar,
 ...
 * @ingroup Axis
 */
LINKTOADDON NumberFormat_e TecUtilAxisLabelGetNumberFormat(char    Axis,
                                                                   int32_t AxisNum);
 ...
 * @ingroup Axis
 */
LINKTOADDON TP_GIVES char* TecUtilAxisLabelGetTimeDateFormat(char    Axis,
                                                                     int32_t AxisNum);
 ...
 * @ingroup Axis
 */
LINKTOADDON int32_t TecUtilAxisLabelGetPrecisionFormat(char    Axis,
                                                               int32_t AxisNum);
 ...
 *
 */
LINKTOADDON double TecUtilAxisGetNextRangeValue(char      Axis,
                                                        int32_t   AxisNum,
                                                        double    CurrentValue,
 ...
 *
 */
LINKTOADDON double TecUtilGetNextNiceIncDecValue(double    startValue,
                                                         double    minValue,
                                                         double    maxValue,
 ...
 * @ingroup Pick
 */
LINKTOADDON AxisSubObject_e TecUtilPickListGetAxisSubObject(int32_t PickListIndex);
 ...
 *
 */
LINKTOADDON char TecUtilPickListGetAxisKind(int32_t PickListIndex);
 ...
 *
 */
LINKTOADDON int32_t TecUtilPickListGetAxisNumber(int32_t PickListIndex);
 ...
 *
 */
LINKTOADDON EntIndex_t TecUtilPickListGetZoneNumber(int32_t PickListIndex) TP_DIRECT;
 ...
 *
 */
LINKTOADDON int32_t TecUtilPickListGetSliceGroup(int32_t PickListIndex) TP_DIRECT;
 ...
 *
 */
LINKTOADDON int32_t TecUtilPickListGetIsoSurfaceGroup(int32_t PickListIndex) TP_DIRECT;
 ...
 *
 */
LINKTOADDON void TecUtilPickListGetZoneIndices(int32_t           PickListIndex,
 ...
 * #internalattributes exclude_python, exclude_sdkdoc
 */
LINKTOADDON EntIndex_t TecUtilPickListGetXYMapNumber(int32_t PickListIndex);
 ...
 *
 */
LINKTOADDON EntIndex_t TecUtilPickListGetLineMapNumber(int32_t PickListIndex);
 ...
 * #internalattributes exclude_python, exclude_sdkdoc
 */
LINKTOADDON LgIndex_t TecUtilPickListGetXYMapIndex(int32_t PickListIndex);
 ...
 *
 */
LINKTOADDON LgIndex_t TecUtilPickListGetLineMapIndex(int32_t PickListIndex);
 ...
 *
 */
LINKTOADDON TextID_t TecUtilPickListGetText(int32_t PickListIndex);
 ...
 *
 */
LINKTOADDON GeomID_t TecUtilPickListGetGeom(int32_t PickListIndex);
 ...
 *
 */
LINKTOADDON void TecUtilPickListGetGeomInfo(int32_t             PickListIndex,
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilVarGetMinMax(EntIndex_t     Var,
 ...
 * @ingroup Variables
 */
LINKTOADDON Boolean_t TecUtilVarGetNonBlankedMinMax(Set_pa         ZoneSet,
                                                            EntIndex_t     Var,
                                                            TP_OUT double* VarMin,
                                                            TP_OUT double* VarMax);

/**
 * Gets the logically unique corner (aka linear) nodes, cell size, and cell center position of an
 ...
 *
 *
 * Get the unique element corner (aka linear) nodes for an cell 362 and 535 of zone 5 letting
 * Tecplot allocate the array of unique nodes. We assume X, Y, and Z are the first three variables.
 * @code
 ...
 */
LINKTOADDON Boolean_t TecUtilDataFEPolyGetCellNodesSizeAndCenter(FaceMap_pa                          FaceMap,
                                                                                ...
                                                                                TP_OUT Boolean_t*                   HasMixedOrientationFaces) TP_DIRECT;
 ...
 *
 * @return
 *     TRUE if successful, FALSE if the connectivity or zone metrics couldn't be loaded.
 *
 * @pre Must have one or more frames.
 * @pre Current frame must have a data set with at least one zone.
 *
 ...
 *   ElemFaceOffset_t FaceIndex = 0; // ...0 because we want the unique nodes for the entire cell
 *   LgIndex_t        NumUniqueNodes;
 *   LgIndex_t        UniqueNodesSize = 0;    // ...let Tecplot allocate
 *   LgIndex_t       *UniqueNodes     = NULL; // ...let Tecplot allocate
 *   IsOk = TecUtilDataFECellGetUniqueNodes(Zone, FaceIndex, 362,
 *                                          &NumUniqueNodes,
 *                                          &UniqueNodesSize,
 *                                          &UniqueNodes);
 *   if (IsOk)
 ...
 *   if (IsOk)
 *     {
 *       IsOk = TecUtilDataFECellGetUniqueNodes(Zone, FaceIndex, 535,
 *                                              &NumUniqueNodes,
 *                                              &UniqueNodesSize,
 *                                              &UniqueNodes);
 *     }
 ...
 *   ElemFaceOffset_t FaceIndex = 2; // ...face 2 of the brick
 *   LgIndex_t        NumUniqueNodes;
 ...
 *   IsOk = TecUtilDataFECellGetUniqueNodes(Zone, FaceIndex, 276,
 *                                          &NumUniqueNodes,
 *                                          &UniqueNodesSize,
 *                                          &ClassicUniqueNodes);
 *   if (IsOk)
 ...
 *   if (IsOk)
 *     {
 *       FaceIndex = 6; // ...face 6 of the brick
 *       IsOk = TecUtilDataFECellGetUniqueNodes(Zone, FaceIndex, 657,
 *                                              &NumUniqueNodes,
 *                                              &UniqueNodesSize,
 *                                              &ClassicUniqueNodes);
 *     }
 ...
 * #internalattributes exclude_fglue, exclude_python, exclude_tcl
 */
LINKTOADDON Boolean_t TecUtilDataFECellGetUniqueNodes(EntIndex_t                          Zone,
                                                      ElemFaceOffset_t                    FaceIndex,
                                                      LgIndex_t                           CellIndex,
                                                      TP_OUT int32_t*                     NumUniqueNodes,
                                                      TP_IN_OUT int32_t*                  UniqueNodesSize,
                                                      TP_ARRAY_RECEIVES_GIVES LgIndex_t** UniqueNodes);
 ...
 *   ones based face number.
 * @param section
 *   The section index of the cell to query.
 * @param CellIndex
 *   The cell index to query. If the zone is a multi-sectioned FE-mixed zone then
 *   the cell index is local within the section.
 * @param NumUniqueNodes
 *   Pointer to the resulting number of unique nodes.
 * @param UniqueNodesSize
 *   As input this value is a pointer to the current dimension of the
 ...
 * @ingroup DataStructure
 */
LINKTOADDON Boolean_t TecUtilDataFECellGetUniqueNodesBySection(
    EntIndex_t                          Zone,
    ElemFaceOffset_t                    FaceIndex,
    EntIndex_t                          section,
    LgIndex_t                           CellIndex,
 ...
 *
 */
LINKTOADDON void TecUtilDataFECellGetNodes(EntIndex_t        Zone,
                                           int32_t           Face,
                                           LgIndex_t         CellIndex,
                                           TP_OUT LgIndex_t* I1,
                                           TP_OUT LgIndex_t* I2,
                                           ...
                                           TP_OUT LgIndex_t* I4);
/**
 * Get the face node ordering for a given face of a specific FE cell type.
 *
 * @param cellShape
 *      The geometric shape of the cell
 * @param gridOrder
 *      Order of the grid. Use 1 for linear and 2+ for high-order cells.
 * @param basisFn
 *      Basis function of the cell determining the node winding.
 *      Currently, only Lagrangian is supported.
 * @param face
 *      The one-based face index.
 * @param nodeOrdering
 *      Pre-allocated array to be filled with the one-based node ordering
 *      for the requested face.
 *
 * @since
 *   2023.1
 */
LINKTOADDON void TecUtilFECellGetFaceNodeOrdering(
    FECellShape_e cellShape,
    EntIndex_t gridOrder,
    FECellBasisFunction_e basisFn,
    EntIndex_t face,
    TP_OUT EntIndex_t* nodeOrdering);

/**
 * Get the indices for the nodes a cell in an ordered zone. Zone metrics are needed
 * for the calculation and if they fail to load -1 is returned for the cell indices.
 * This function is \ref threadsafe.
 *
 * @param Zone
 ...
 *   array as a one-dimensional array. If the zone metrics fail to load -1
 *   is returned.
 *
 * @param I2
 ...
 *
 *   // Add code here to make sure data exists and the zone
 *   // exists and is the right size and type and error handling
 ...
 *
 */
LINKTOADDON void TecUtilDataIJKCellGetIndices(EntIndex_t        Zone,
                                              IJKPlanes_e       Plane,
                                              LgIndex_t         CellIndex,
                                              TP_OUT LgIndex_t* I1,
                                              TP_OUT LgIndex_t* I2,
 ...
 *
 */
LINKTOADDON GetValueReturnCode_e TecUtilStyleGetLowLevelX(ArgList_pa ArgList) TP_DIRECT;
 ...
 * @ingroup StyleValue
 */
LINKTOADDON TP_GIVES char* TecUtilStyleGetLastErrorString();
 ...
 *
 */
LINKTOADDON void TecUtilPostLastErrorMessage() TP_DIRECT;
 ...
 */
LINKTOADDON TP_GIVES char* TecUtilLastErrorMessage();
 ...
 * @ingroup UserInterface
 */
LINKTOADDON void TecUtilLastErrorMessageClear();
 ...
 *
 */
LINKTOADDON ArbParam_t TecUtilFieldStyleGetArbValue(EntIndex_t  Zone,
                                                                   const char *S1,
                                                                   const char *S2,
                                                                   const char *S3) TP_DIRECT;
 ...
 *
 */
LINKTOADDON double TecUtilFieldStyleGetDoubleValue(EntIndex_t  Zone,
                                                           const char *S1,
                                                           const char *S2,
                                                           const char *S3);
 ...
 * #internalattributes exclude_python, exclude_sdkdoc
 */
LINKTOADDON ArbParam_t TecUtilXYMapStyleGetArbValue(EntIndex_t  XYMap,
                                                            const char *S1,
                                                            const char *S2,
                                                            const char *S3);
 ...
 *
 */
LINKTOADDON ArbParam_t TecUtilLineMapStyleGetArbValueForFrame(UniqueID_t FrameID,
                                                                      EntIndex_t  LineMap,
                                                                      const char *S1,
                                                                      const char *S2,
                                                                      const char *S3);
 ...
 *
 */
LINKTOADDON ArbParam_t TecUtilLineMapStyleGetArbValue(EntIndex_t  LineMap,
                                                              const char *S1,
                                                              const char *S2,
                                                              const char *S3);
 ...
 * #internalattributes exclude_python, exclude_sdkdoc
 */
LINKTOADDON double TecUtilXYMapStyleGetDoubleValue(EntIndex_t  XYMap,
                                                           const char *S1,
                                                           const char *S2,
                                                           const char *S3);
 ...
 *
 */
LINKTOADDON double TecUtilLineMapStyleGetDoubleValue(EntIndex_t  LineMap,
                                                             const char *S1,
                                                             const char *S2,
                                                             const char *S3);
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilStateIsProcessingMacro() TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilStateIsProcessingStylesheet() TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilStateIsProcessingJournal() TP_DIRECT;
/**
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilStateIsProcessingLayout() TP_DIRECT;
 ...
 * @ingroup FrameManagement
 */
LINKTOADDON UniqueID_t TecUtilFrameGetDataSetUniqueIDByFrameID(UniqueID_t frameID) TP_DIRECT;
 ...
 * @ingroup FrameManagement
 */
LINKTOADDON UniqueID_t TecUtilFrameGetActiveID() TP_DIRECT;
 ...
 * @ingroup FrameManagement
 */
LINKTOADDON UniqueID_t TecUtilFrameGetUniqueID() TP_DIRECT;
 ...
 *
 */
LINKTOADDON UniqueID_t TecUtilDataSetGetUniqueID() TP_DIRECT;

/**
 * Gets the unique IDs for the specified array of zones for the current dataset. A unique ID is an
 * integer that uniquely identifies a zone. For any zone specified that does not yet exist, a unique
 * ID is reserved for it for when it is created in the future. An add-on can use these IDs to
 * internally keep track of a set of zones. TecUtilZoneGetNumByUniqueID() can be used to convert
 * between a unique ID and a zone number.
 * This function is \ref threadsafe.
 *
 * @since
 *   2021.2
 *
 * @param zones
 *     Array of zones number for which unique IDs are desired.
 * @para numZones
 *     Number of zones in the array.
 * @param uniqueIDs
 *     Pre-allocated array, large enough to hold \ref numZones unique IDs corresponding to the zones
 *     in the zone array.
 *
 * @pre Must have one or more frames.
 *
 *
 * @sa TecUtilZoneGetUniqueID, TecUtilZoneGetUniqueIDForFrame,
 *     TecUtilZoneGetUniqueIDByDataSetID, TecUtilZoneGetNumByUniqueID
 *
 * @ingroup Zone
 */
LINKTOADDON void TecUtilDataSetGetUniqueIDsForZones(const EntIndex_t*        zones,
                                                    EntIndex_t               numZones,
                                                    TP_ARRAY_OUT UniqueID_t* uniqueIDs) TP_DIRECT;

/**
 * Gets a unique ID for a zone. A unique ID is an integer that uniquely identifies a zone. If the
 * zone does not yet exist, a unique ID is reserved for it for when it is created in the future. An
 * add-on can use these IDs to internally keep track of a set of zones.
 ...
 * @endcode
 *
 * @sa TecUtilDataSetGetUniqueIDsForZones, TecUtilZoneGetUniqueIDForFrame,
 *     TecUtilZoneGetUniqueIDByDataSetID, TecUtilZoneGetNumByUniqueID
 *
 * @ingroup Zone
 */
LINKTOADDON UniqueID_t TecUtilZoneGetUniqueID(EntIndex_t Zone) TP_DIRECT;
 ...
 *
 */
LINKTOADDON UniqueID_t TecUtilZoneGetUniqueIDByDataSetID(UniqueID_t DataSetID,
 ...
 *
 */
LINKTOADDON UniqueID_t TecUtilZoneGetUniqueIDForFrame(UniqueID_t FrameID,
                                                                     EntIndex_t Zone) TP_DIRECT;
 ...
 *
 */
LINKTOADDON UniqueID_t TecUtilVarGetUniqueID(EntIndex_t Var) TP_DIRECT;
 ...
 *
 */
LINKTOADDON UniqueID_t TecUtilVarGetUniqueIDByDataSetID(UniqueID_t DataSetID,
 ...
 *
 */
LINKTOADDON UniqueID_t TecUtilVarGetUniqueIDForFrame(UniqueID_t FrameID,
                                                                    EntIndex_t Var) TP_DIRECT;
 ...
 *
 */
LINKTOADDON UniqueID_t TecUtilLineMapGetUniqueID(EntIndex_t LineMap) TP_DIRECT;
 ...
 *
 */
LINKTOADDON EntIndex_t TecUtilVarGetNumByUniqueID(UniqueID_t UniqueID) TP_DIRECT;
 ...
 *
 */
LINKTOADDON EntIndex_t TecUtilLineMapGetNumByUniqueID(UniqueID_t UniqueID) TP_DIRECT;
 ...
 *
 * @return
 *   The zone's current index associated with the unique ID. If there is no zone number for the
 *   given unique ID, the return value is
 *   \ref INVALID_UNIQUE_ID.
 *
 * @pre Must have one or more frames.
 *
 *
 ...
 * @ingroup Zone
 *
 * @sa TecUtilZoneGetUniqueID, TecUtilDataSetGetUniqueIDsForZones
 */
LINKTOADDON EntIndex_t TecUtilZoneGetNumByUniqueID(UniqueID_t UniqueID) TP_DIRECT;
 ...
 *
 */
LINKTOADDON EntIndex_t TecUtilVarGetNumByAssignment(char Var) TP_DIRECT;
 ...
 *
 */
LINKTOADDON EntIndex_t TecUtilVarGetNumByName(const char *VarName) TP_DIRECT;
 ...
 *
 */
LINKTOADDON VarStatus_e TecUtilVarGetStatus(EntIndex_t  Zone,
                                                           EntIndex_t  Var) TP_DIRECT;
 ...
 *
 */
LINKTOADDON VarStatus_e TecUtilVarGetStatusByRef(FieldData_pa FieldData) TP_DIRECT;
 ...
 */
LINKTOADDON void* TecUtilDataValueGetRawPtrByRef(FieldData_pa FieldData) TP_DIRECT;
 ...
 * #internalattributes exclude_tcl
 */
LINKTOADDON const void* TecUtilDataValueGetReadableRawPtrByRef(FieldData_pa FieldData) TP_DIRECT;
 ...
 * #internalattributes exclude_tcl
 */
LINKTOADDON void TecUtilDataValueGetReadableRawPtr(EntIndex_t              Zone, /* <-activex> */
                                                                  EntIndex_t              Var,
                                                                  TP_ARRAY_OUT void**     DataPtr,
                                                                  TP_OUT FieldDataType_e* FieldDataType) TP_DIRECT;
 ...
 * #internalattributes exclude_tcl
 */
LINKTOADDON void* TecUtilDataValueGetWritableRawPtrByRef(FieldData_pa FieldData) TP_DIRECT;
 ...
 * #internalattributes exclude_tcl
 */
LINKTOADDON void TecUtilDataValueGetWritableRawPtr(EntIndex_t              Zone, /* <-activex> */
                                                                  EntIndex_t              Var,
                                                                  TP_ARRAY_OUT void**     DataPtr,
                                                                  TP_OUT FieldDataType_e* FieldDataType) TP_DIRECT;
 ...
 */
LINKTOADDON void TecUtilDataValueGetRawPtr(EntIndex_t              Zone, /* <-activex> */
                                                          EntIndex_t              Var,
                                                          TP_ARRAY_OUT void**     DataPtr,
                                                          TP_OUT FieldDataType_e* FieldDataType) TP_DIRECT;
 ...
 * @ingroup DataServices
 */
LINKTOADDON ElementOrientation_pa TecUtilElemOrientGetReadableRef(EntIndex_t Zone) TP_DIRECT;
 ...
 * @ingroup DataServices
 */
LINKTOADDON ElementOrientation_e TecUtilElemOrientGetOrientation(ElementOrientation_pa ElementOrientation,
                                                                                LgIndex_t             Element) TP_DIRECT;
 ...
 * #internalattributes exclude_tcl
 */
LINKTOADDON void TecUtilDataNodeGetRawPtr(EntIndex_t             Zone,
                                                         TP_ARRAY_OUT int32_t** NodeMapPtr) TP_DIRECT;
 ...
 * @ingroup DataServices
 */
LINKTOADDON OffsetDataType_e TecUtilDataNodeGetRawItemType(NodeMap_pa NodeMap) TP_DIRECT;
 ...
 * @ingroup DataServices
 */
LINKTOADDON int32_t* TecUtilDataNodeGetRawPtrByRef(NodeMap_pa NodeMap) TP_DIRECT;
 ...
 * @ingroup DataServices
 */
LINKTOADDON int64_t* TecUtilDataNodeGetRawPtrByRef64(NodeMap_pa NodeMap) TP_DIRECT;
 ...
 * @ingroup DataServices
 */
LINKTOADDON const int32_t* TecUtilDataNodeGetReadableRawPtrByRef(NodeMap_pa NodeMap) TP_DIRECT;
 ...
 * @ingroup DataServices
 */
LINKTOADDON const int64_t* TecUtilDataNodeGetReadableRawPtrByRef64(NodeMap_pa NodeMap) TP_DIRECT;
 ...
 * @ingroup DataServices
 */
LINKTOADDON int32_t* TecUtilDataNodeGetWritableRawPtrByRef(NodeMap_pa NodeMap) TP_DIRECT;
 ...
 * @ingroup DataServices
 */
LINKTOADDON int64_t* TecUtilDataNodeGetWritableRawPtrByRef64(NodeMap_pa NodeMap) TP_DIRECT;
 ...
 * @ingroup DataServices
 */
LINKTOADDON OffsetDataType_e TecUtilDataFaceNbrRawItemType(FaceNeighbor_pa FaceNeighbor) TP_DIRECT;
 ...
 * #internalattributes exclude_python, exclude_sdkdoc, exclude_tcl
 */
LINKTOADDON void TecUtilDataFaceNbrGetRawPtr(EntIndex_t             Zone,
                                                            TP_ARRAY_OUT int32_t** FNPtr) TP_DIRECT;
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilZoneGetNameByDataSetID(UniqueID_t      DataSetID,
                                                                   EntIndex_t      Zone,
                                                                   TP_GIVES char** ZName) TP_DIRECT;
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilZoneGetNameForFrame(UniqueID_t      FrameID,
                                                                EntIndex_t      Zone,
                                                                TP_GIVES char** ZName) TP_DIRECT;
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilZoneGetName(EntIndex_t      Zone,
                                                        TP_GIVES char** ZName) TP_DIRECT;
 ...
 * @ingroup Zones
 */
LINKTOADDON Boolean_t TecUtilZoneGetUniqueIDsByDataSetID(UniqueID_t dataSetID,
                                                                        TP_OUT EntIndex_t* numZoneIDs,
                                                                        TP_ARRAY_GIVES UniqueID_t** zoneIDs) TP_DIRECT;
 ...
 * @ingroup Zones
 */
LINKTOADDON Boolean_t TecUtilZoneGetTypesByDataSetID(UniqueID_t dataSetID,
                                                                    TP_OUT EntIndex_t* numTypes,
                                                                    TP_ARRAY_GIVES ZoneType_e** types) TP_DIRECT;
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilZoneGetNamesByDataSetID(UniqueID_t dataSetID,
                                                                    TP_GIVES StringList_pa* names) TP_DIRECT;
 ...
 */
LINKTOADDON Boolean_t TecUtilZoneGetEnabledNamesByDataSetID(UniqueID_t dataSetID,
                                                                           TP_GIVES StringList_pa* names) TP_DIRECT;
 ...
 *
 *
 * @pre <em>VarIsValid(dataSet, var)</em>
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilVarGetNameByDataSetID(UniqueID_t      DataSetID,
                                                   EntIndex_t      VarNum,
                                                   TP_GIVES char** VName) TP_DIRECT;
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilVarGetNameForFrame(UniqueID_t      FrameID,
                                                EntIndex_t      VarNum,
                                                TP_GIVES char** VName) TP_DIRECT;
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilVarGetName(EntIndex_t      VarNum,
                                        TP_GIVES char** VName) TP_DIRECT;
 ...
 * @ingroup Variables
 */
LINKTOADDON Boolean_t TecUtilVarGetUniqueIDsByDataSetID(UniqueID_t dataSetID,
                                                                       TP_OUT EntIndex_t* numVarIDs,
                                                                       TP_ARRAY_GIVES UniqueID_t** varIDs) TP_DIRECT;
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilVarGetNamesByDataSetID(UniqueID_t dataSetID,
                                                    TP_GIVES StringList_pa* names) TP_DIRECT;
 ...
 */
LINKTOADDON Boolean_t TecUtilVarGetEnabledNamesByDataSetID(UniqueID_t dataSetID,
                                                           TP_GIVES StringList_pa* names) TP_DIRECT;


/**
 * Get variable number gleaned from a string that could either be one or more digits or a variable name.
 * If one or more digits then the variable number is just the conversion to an integer.  If a variable name
 * then it is the offset in the dataset for that variable name.
 *
 * @since 2020.2
 *
 * This function is \ref threadsafe.
 *
 * @param varToken
 *   string token that can either be a string of one or more digits or a variable name.
 *   If it is a variable name then it must be enclosed in outer quotes (single or double).
 *
 * @param allowZero
 *   If TRUE the zero is allowed for assignment.  Some addons use zero to denote unassigned.
 *
 * @param varNum
 *   Resulting variable number.  Pointer to an EntIndex_t
 *
 * @return
 *   VarParseReturnCode_e, which can be one of:
 ...
 *
 * <FortranSyntax>
 *    INTEGER*4 FUNCTION TecUtilVarGetNumFromStyleString(varToken,
 *                                                       varNum)
 *    CHARACTER*(*)   varToken
 *    INTEGERER*4     varNum
 * </FortranSyntax>
 ...
 * @code
 *   EntIndex_t varNum;
 *   if (TecUtilVarGetNumFromStyleString(varToken, &varNum) == VarParseReturnCode_Ok)
 *   {
 *    // do something with varNum
 *   }
 * @endcode
 *
 * @ingroup Variables
 *
 */
LINKTOADDON VarParseReturnCode_e TecUtilVarGetNumFromStyleString(const char* varToken,
                                                                 Boolean_t   allowZero,
                                                                 TP_OUT EntIndex_t* varNum) TP_DIRECT;



/**
 * Get the string to use in a macro command that represents a given variable number.
 *
 * @since 2020.2
 *
 * This function is \ref threadsafe.
 ...
 *   variable number.
 *
 * @param varStyleString
 *   The returned style string.
 *
 *   If the engine is currently set to write out variable references by name :
 *      Return the name of the variable (possibly decorated if there are duplicate variable
 *      names in the dataset).  The name will have double or single quotes around the name.
 *
 *   If the engine is currently set to write out variable references by offset :
 *      Return the ASCII representation of the variable number in the dataset.
 *
 *   Once you are finished with varStyleString you must deallocate it using
 *   TecUtilStringDealloc.
 *
 *   NOTE: To change how the engine writes out variable references
 *         use the setting:  $!FileConfig WriteOutVariableReferencesByName
 *
 *
 * @return
 *   TRUE if successful, FALSE otherwise.
 ...
 *
 * <FortranSyntax>
 *    INTEGER*4 FUNCTION TecUtilVarGetStyleStringFromNum(varNum,
 *                                                       varStyleString)
 *    INTEGERER*4     varNum
 *    CHARACTER*(*)   varStyleString
 *    INTEGER*4       varStyleStringLength
 * </FortranSyntax>
 *
 * @code
 *   char* varStyleString = nullptr;
 *   if (TecUtilVarGetStyleStringFromNum(varNum, &varStyleString))
 *   {
 *       // do something with varStyleString
 *       .
 *       .
 *       TecUtilStringDealloc(&varStyleString);
 *   }
 * @endcode
 *
 * @ingroup Variables
 *
 */
LINKTOADDON Boolean_t TecUtilVarGetStyleStringFromNum(EntIndex_t      varNum,
                                                      TP_GIVES char** varStyleString) TP_DIRECT;


/**
 * Get the state of whether or not using names for variable assigments is active or not.
 *
 * @since 2020.2
 *
 * This function is \ref threadsafe.
 *
 * @return
 *   TRUE if using names for variable assignments is active else FALSE.
 *
 * <FortranSyntax>
 *    INTEGER*4 FUNCTION TecUtilUseNamesForVariableAssignments()
 * </FortranSyntax>
 *
 * @code
 *   if (TecUtilUseNamesForVariableAssignments())
 *   {
 *       //... do something knowing names are used for variable assignments.
 *   }
 * @endcode
 *
 * @ingroup StyleValue
 *
 */
LINKTOADDON Boolean_t TecUtilUseNamesForVariableAssignments() TP_DIRECT;
 ...
 * #internalattributes exclude_python, exclude_sdkdoc
 */
LINKTOADDON Boolean_t TecUtilXYMapGetName(EntIndex_t      Map,
                                          TP_GIVES char** Name);
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilLineMapGetNameForFrame(UniqueID_t FrameID,
                                                            EntIndex_t      Map,
                                                            TP_GIVES char** Name);
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilLineMapGetName(EntIndex_t      Map,
                                                    TP_GIVES char** Name);
 ...
 * @ingroup DataValue
 */
LINKTOADDON LgIndex_t TecUtilDataValueGetCountByRef(FieldData_pa FieldData) TP_DIRECT;
 ...
 *
 * @param IMax
 *   Receives the I-dimension for ordered data. Number of data points for FE-data. Passing NULL
 *   indicates the value is not desired. A value of -1 if the metric failed to load.
 *
 * @param JMax
 *   Receives the J-dimension for ordered data. Number of elements for FE-data. Passing NULL
 *   indicates the value is not desired. A value of -1 if the metric failed to load.
 *
 * @param KMax
 *   Receives the K-dimension for ordered data. Number of nodes per cell for cell-based FE-data
 *   (triangle, brick, tetrahedral, quadtrilateral).  Number of faces for face-based FE-data
 *   (polygons and polyhedrons).  Passing NULL indicates the value is not desired. A value of -1 if
 *   the metric failed to load.
 *
 * @param XVar
 ...
 * @since 14.1
 *
 * @sa TecUtilZoneGetInfo, TecUtilZoneGetIJK, TecUtilZoneGetIJKByUniqueID,
 * TecUtilZoneGetMetrics, TecUtilZoneGetMetricsByUniqueID,
 * TecUtilZoneMetricsLoad, TecUtilZoneMetricsLoadByUniqueID
 *
 * #internalattributes exclude_tcl
 */
LINKTOADDON void TecUtilZoneGetInfoForFrame(UniqueID_t           FrameID,
                                            EntIndex_t           CurZone,
 ...
 * @endcode
 *
 * @sa TecUtilZoneGetInfoByFrame, TecUtilZoneGetIJK, TecUtilZoneGetIJKByUniqueID,
 * TecUtilZoneGetMetrics, TecUtilZoneGetMetricsByUniqueID,
 * TecUtilZoneMetricsLoad, TecUtilZoneMetricsLoadByUniqueID
 *
 * @ingroup Zone
 ...
 * #internalattributes exclude_tcl
 */
LINKTOADDON void TecUtilZoneGetInfo(EntIndex_t           CurZone,
                                    TP_OUT LgIndex_t*    IMax,
                                    TP_OUT LgIndex_t*    JMax,
                                    TP_OUT LgIndex_t*    KMax,
                                    TP_OUT FieldData_pa* XVar,
...
/**
 * Used to obtain the I, J, and K dimensions of a specific zone, loading the zone metrics if
 * required.
 * This function is \ref threadsafe.
 *
 * @param CurZone
 ...
 *   Receives the K-dimension for ordered data. Number of nodes per cell for cell-based FE-data
 *   (triangle, brick, tetrahedral, quadtrilateral).  Number of faces for face-based FE-data
 *   (polygons and polyhedrons).  If face generation is deferred via
 *   TecUtilDataFaceMapAssignElemToNodeMap or TecUtilDataFaceMapAssignElemToNodeMap64() this value
 *   will be 0 until faces are calculated.  Passing NULL indicates the value is not desired. A value
 *   of -1 if the metric failed to load.
 *
 * @pre Must have one or more frames.
 * @pre Current frame must have a data set with at least one zone.
 *
 ...
 *
 * @sa
 *   TecUtilZoneGetInfoForFrame, TecUtilZoneGetInfo, TecUtilZoneGetIJKByUniqueID,
 *   TecUtilZoneGetMetrics, TecUtilZoneGetMetricsByUniqueID,
 *   TecUtilZoneMetricsLoad, TecUtilZoneMetricsLoadByUniqueID
 *
 * @ingroup Zone
 *
 */
LINKTOADDON void TecUtilZoneGetIJK(EntIndex_t        CurZone,
                                   TP_OUT LgIndex_t* IMax,
                                   TP_OUT LgIndex_t* JMax,
                                   TP_OUT LgIndex_t* KMax);

/**
 * Used to obtain the I, J, and K dimensions of a specific zone in the specified data set, loading
 * the zone metrics if required.
 * This function is \ref threadsafe.
 *
 * @param DatasetID
 ...
 *   (polygons and polyhedrons).  If face generation is deferred via
 *   TecUtilDataFaceMapAssignElemToNodeMap or TecUtilDataFaceMapAssignElemToNodeMap64() this value
 *   will be 0 until faces are calculated.  Passing NULL indicates that the value is not desired. A
 *   value of -1 if the metric failed to load.
 *
 *
 * @pre <em>IMax</em>
 *   Pointer must be a valid address or NULL.
 ...
 *   LgIndex_t IMax;
 *   // Use NULL for values we're not interested in
 *   TecUtilZoneGetIJKByUniqueID(1, 1, &IMax,NULL,NULL);
 * @endcode
 *
 * @sa
 *   TecUtilZoneGetInfoForFrame, TecUtilZoneGetInfo, TecUtilZoneGetIJK,
 *   TecUtilZoneGetMetrics, TecUtilZoneGetMetricsByUniqueID,
 *   TecUtilZoneMetricsLoad, TecUtilZoneMetricsLoadByUniqueID
 *
 * @since 14.1
 ...
 *
 */
LINKTOADDON void TecUtilZoneGetIJKByUniqueID(UniqueID_t        DatasetID,
                                             EntIndex_t        Zone,
                                             TP_OUT LgIndex_t* IMax,
                                             TP_OUT LgIndex_t* JMax,
                                             TP_OUT LgIndex_t* KMax);
...
/**
 * Used to obtain the zone metrics (nodes, elements, faces) without forcing the metrics to be
 * loaded. Some data file formats require reading an extensive amount of data to discern the
 * metrics. Performing extensive reading at the time the user selects the data files for loading can
 * increase the time to show a plot, especially when loading many time steps of transient data. A
 * data loader can elect to register a load-on-demand callback, via TecUtilDataSetAddZoneX(), to
 * supply any deferred zone metrics at the time they are needed. Any deferred metric value returns a
 * value of -1. Calling TecUtilZoneMetricsLoadByUniqueID() prior to this query will ensure that zone
 * metrics are loaded for this zone.
 *
 * This function is \ref threadsafe.
 *
 * @param DatasetID
 ...
 *     Number of the zone to query.
 * @param numIPts
 *     Pointer to the number of I points in the zone or NULL if they metric value isn't desired. A
 *     value of -1 indicates that the number of I points was not known at the time of registration
 *     and is deferred until it is first requested. For ordered data this is simply the number of
 *     points in the I dimension. For classic FE and polytope data this is the number of unique
 *     nodes in the zone.
 * @param numJPts
 *     Pointer to the number of J points in the zone or NULL if they metric value isn't desired. A
 *     value of -1 indicates that the number of J points was not known at the time of registration
 *     and is deferred until it is first requested. For ordered data this is simply the number of
 *     points in the J dimension. For classic FE and polytope data this is the number of elements in
 *     the zone.
 * @param numKPts
 *     Pointer to the number of K points in the zone or NULL if they metric value isn't desired. A
 *     value of -1 indicates that the number of K points was not known at the time of registration
 *     and is deferred until it is first requested. For ordered data this is simply the number of
 *     points in the K dimension. For classic FE data this is the number of nodes per element and it
 *     is set by Tecplot based on the zone type. For polytope data this is the number of unique
 *     faces in the zone.
 * @param numFaceNodes
 *     Pointer to the total number of face nodes for the unique faces in the polytope zone or NULL
 *     if the metric value isn't desired. For polytope zones a value of -1 indicates that the number
 *     of number face nodes for the unique faces was not known at the time of registration and is
 *     deferred until it is first requested. For all other zone types the metric value is zero.
 * @param numFaceBndryFaces
 *     Pointer to the total number of boundary faces in the polytope zone or NULL if the metric
 *     value isn't desired. For polytope zones a value of -1 indicates that the number of boundary
 *     faces was not known at the time of registration and is deferred until it is first requested.
 *     For all other zone types the metric value is zero.
 * @param numFaceBndryConns
 *     Pointer to the total number of boundary connected elements or element/zone pairs in the
 *     polytope or NULL if the metric value isn't desired. For polytope zones a value of -1
 *     indicates that the number of boundary face connections was not known at the time of registration
 *     and is deferred until it is first requested. For all other zone types the metric value is
 *     zero.
 *
 *
 * @pre <em>numIPts</em>
 ...
 *   Pointer must be a valid address or NULL.
 *
 * @pre <em>numFaceNodes</em>
 *   Pointer must be a valid address or NULL.
 *
 * @pre <em>numFaceBndryFaces</em>
 *   Pointer must be a valid address or NULL.
 *
 * @pre <em>numFaceBndryConns</em>
 *   Pointer must be a valid address or NULL.
 *
 *
 * <FortranSyntax>
 *    SUBROUTINE TecUtilZoneGetMetricsByUniqueID(
 *   &           DatasetID,
 *   &           Zone,
 *   &           numIPts,
 *   &           numJPts,
 ...
 * @sa
 *     TecUtilZoneGetInfoForFrame, TecUtilZoneGetInfo, TecUtilZoneGetIJK,
 *     TecUtilZoneGetMetrics, TecUtilZoneMetricsLoad, TecUtilZoneMetricsLoadByUniqueID
 *
 * @since
 *     2020.2
 *
 * @ingroup Zone
 */
LINKTOADDON void TecUtilZoneGetMetricsByUniqueID(UniqueID_t        DatasetID,
                                                 EntIndex_t        Zone,
                                                 TP_OUT LgIndex_t* numIPts,
                                                 TP_OUT LgIndex_t* numJPts,
                                                 TP_OUT LgIndex_t* numKPts,
                                                 TP_OUT LgIndex_t* numFaceNodes,
                                                 TP_OUT LgIndex_t* numFaceBndryFaces,
                                                 TP_OUT LgIndex_t* numFaceBndryConns) TP_DIRECT;
 ...
 * data loader can elect to register a load-on-demand callback, via TecUtilDataSetAddZoneX(), to
 * supply any deferred zone metrics at the time they are needed. Any deferred metric value returns a
 * value of -1. Calling TecUtilZoneMetricsLoad() prior to this query will ensure that zone
 * metrics are loaded for this zone.
 *
 * This function is \ref threadsafe.
 *
 ...
 *     Pointer to the total number of boundary connected elements or element/zone pairs in the
 *     polytope or NULL if the metric value isn't desired. For polytope zones a value of -1
 *     indicates that the number of boundary face connections was not known at the time of
 *     registration and is deferred until it is first requested. For all other zone types the metric
 *     value is zero.
 *
 * @pre Must have one or more frames.
 * @pre Current frame must have a data set with at least one zone.
 ...
 *
 * <FortranSyntax>
 *    SUBROUTINE TecUtilZoneGetMetrics(
 *   &           DatasetID,
 *   &           Zone,
 *   &           numIPts,
 *   &           numJPts,
 ...
 * @sa
 *     TecUtilZoneGetInfoForFrame, TecUtilZoneGetInfo, TecUtilZoneGetIJK,
 *     TecUtilZoneGetMetricsByUniqueID, TecUtilZoneMetricsLoad, TecUtilZoneMetricsLoadByUniqueID
 *
 * @since
 *     2020.2
 *
 * @ingroup Zone
 */
LINKTOADDON void TecUtilZoneGetMetrics(EntIndex_t        Zone,
                                       TP_OUT LgIndex_t* numIPts,
                                       TP_OUT LgIndex_t* numJPts,
                                       TP_OUT LgIndex_t* numKPts,
                                       TP_OUT LgIndex_t* numFaceNodes,
...
/**
 * Ensures that the zone metrics for the specified zone are loaded. Some data file formats require
 * reading an extensive amount of data to discern the metrics. Performing extensive reading at the
 * time the user selects the data files for loading can increase the time to show a plot, especially
 * when loading many time steps of transient data. A data loader can elect to register a
 * load-on-demand callback, via TecUtilDataSetAddZoneX(), to supply any deferred zone metrics at the
 ...
 *     A unique ID of a dataset.
 * @param Zone
 *     Number of the zone to ensure metrics are loaded.
 *
 * @return
 *     TRUE if the zone metrics were already load or loaded successfully, and FALSE if loading the
 *     zone metrics fails. Failure can occur if the process was interrupted by the user or if the
 *     loader failed to properly load the metrics for any reason.
 *
 * @sa TecUtilZoneGetMetrics, TecUtilZoneGetMetricsByUniqueID, TecUtilZoneMetricsLoad
 *
 * @since
 *     2020.2
 *
 * @ingroup Zone
 */
LINKTOADDON Boolean_t TecUtilZoneMetricsLoadByUniqueID(UniqueID_t DatasetID,
                                                       EntIndex_t Zone);
 ...
 *
 *
 * @sa TecUtilZoneGetMetrics, TecUtilZoneGetMetricsByUniqueID, TecUtilZoneMetricsLoadByUniqueID
 *
 * @since
 *     2020.2
 *
 * @ingroup Zone
 */
LINKTOADDON Boolean_t TecUtilZoneMetricsLoad(EntIndex_t Zone);

/**
 * Get the current settings from the provided zone metrics object, loading the metrics if
 * neccessary.
 *
 * This function is \ref threadsafe.
 *
 ...
 *      Number of the zone to query.
 * @param numSections
 *     This will return one for classic FE zones, and 1 or more for mixed-FE zones where the zone
 *     type is ZoneType_FEMixed.
 *
 * @return
 *      This function will return FALSE if the zone metrics failed to load.
 *
 *
 * @pre <em>numSections</em>
 *   Pointer must be a valid address and non-NULL.
 *
 *
 * For all other parameters, please refer to the documentation for TecUtilZoneGetMetrics().
 *
 * @since
 *     2023.1
 *
 * @ingroup DataServices
 */
LINKTOADDON Boolean_t TecUtilZoneGetNumSections(
    UniqueID_t dataSetID,
    EntIndex_t zone,
    TP_OUT EntIndex_t* numSections);

/**
 * Get the parameters for a specific section, loading the metrics if necessary.
 *
 * This function is \ref threadsafe.
 *
 * @param dataSetID
 ...
 *      Number of the zone to query.
 * @param sectionIndex
 *      The ones based index to the section to query. This must be less than or equal to the number
 *      of sections (TecUtilZoneMetricsLoad() and TecUtilZoneMetricsGetInfo()).
 * @param cellShape
 *      The specific shape of the cells in this section
 * @param gridOrder
 *      The grid order. For classic (linear) zones, this will be one. For high-order zones, this
 *      will be 2 or greater.
 * @param basisFn
 *      For high-order cells, this indicates the basis function used to calculate positions from
 *      (r, s, t) to the parent volume coordinates. Currently, only FECellBasisFunction_Lagrangian
 *      is supported and is always returned regardless of cell type.
 * @param numElements
 *      The number of elements in this section.
 * @param numCornersPerElem
 *      The number of linear (corner) nodes of this cell shape.
 * @param numNodesPerElem
 *      The total number of nodes (high-order and corner) that make up this cell type.
 *
 * @return
 *      This function will return FALSE if the zone metrics failed to load.
 *
 ...
 *   Pointer must be a valid address and non-NULL.
 *
 * @pre <em>numElements</em>
 *   Pointer must be a valid address and non-NULL.
 *
 * @pre <em>numCornersPerElem</em>
 *   Pointer must be a valid address and non-NULL.
 *
 * @pre <em>numNodesPerElem</em>
 *   Pointer must be a valid address and non-NULL.
 *
 *
 * @since
 ...
 * @ingroup DataServices
 */
LINKTOADDON Boolean_t TecUtilZoneGetSectionMetrics(
    UniqueID_t                    dataSetID,
    EntIndex_t                    zone,
    EntIndex_t                    sectionIndex,
    TP_OUT FECellShape_e*         cellShape,
    TP_OUT EntIndex_t*            gridOrder,
    TP_OUT FECellBasisFunction_e* basisFn,
    TP_OUT LgIndex_t*             numElements,
    TP_OUT EntIndex_t*            numCornersPerElem,
    TP_OUT EntIndex_t*            numNodesPerElem);

/**
 * Determine the zone dimensionality to identify it as a line, surface or volume.
 *   - -1: Zone metrics not loaded
 *   - 1: I-Ordered, J-Ordered, K-Ordered or finite element line
 *   - 2: IJ-Ordered, JK-Ordered, IK-Ordered, or finite element surface
 *   - 3: IJK-Ordered, or finite element volume
 * This function is \ref threadsafe.
 *
 * @param dataSetID
 *      The unique ID of a dataset.
 ...
 *
 * @return
 *     The zone dimension as a line, surface, or volume.
 *
 * @since
 *     2023.1
 *
 * @ingroup DataServices
 */
LINKTOADDON int32_t TecUtilZoneGetDimension(
    UniqueID_t dataSetID,
    EntIndex_t zone);
 ...
 * @ingroup DataServices
 */
LINKTOADDON OffsetDataType_e TecUtilDataSetGetIntItemTypeForContentRange(int64_t MaxValueStoredInArray) TP_DIRECT;
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilDataSetGetInfo(TP_GIVES char**    DataSetTitle,
                                                           TP_OUT EntIndex_t* NumZones,
                                                           TP_OUT EntIndex_t* NumVars) TP_DIRECT;
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilDataSetGetInfoByUniqueID(UniqueID_t         DataSetID,
 ...
 *
 */
LINKTOADDON EntIndex_t TecUtilDataSetGetNumZones() TP_DIRECT;
 ...
 *
 */
LINKTOADDON EntIndex_t TecUtilDataSetGetNumZonesByUniqueID(UniqueID_t DataSetID) TP_DIRECT;
 ...
 *
 */
LINKTOADDON EntIndex_t TecUtilDataSetGetNumZonesForFrame(UniqueID_t FrameID) TP_DIRECT;
 ...
 *
 */
LINKTOADDON EntIndex_t TecUtilDataSetGetNumVars() TP_DIRECT;
 ...
 *
 */
LINKTOADDON EntIndex_t TecUtilDataSetGetNumVarsByUniqueID(UniqueID_t DataSetID) TP_DIRECT;
 ...
 *
 */
LINKTOADDON EntIndex_t TecUtilDataSetGetNumVarsForFrame(UniqueID_t FrameID) TP_DIRECT;
 ...
 *
 */
LINKTOADDON EntIndex_t TecUtilDataSetGetMaxStrandID() TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilDataSetJournalIsValid() TP_DIRECT;
 ...
 * #internalattributes exclude_python, exclude_sdkdoc
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilDataSetRequiresSaving() TP_DIRECT;
 ...
 *
 */
LINKTOADDON void TecUtilFrameGetPosAndSize(TP_OUT double* X,
                                                          TP_OUT double* Y,
                                                          TP_OUT double* Width,
                                                          TP_OUT double* Height) TP_DIRECT;
 ...
 *
 */
LINKTOADDON void TecUtilProbeAtPosSequenceBeginX(ArgList_pa ArgList);
 ...
 *
 */
LINKTOADDON void TecUtilProbeAtPosSequenceEnd();
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilProbeAtPosition(double                 X,
                                             double                 Y,
                                             double                 Z,
                                             ...
                                             Boolean_t              GetNearestPoint) TP_DIRECT;
 ...
 * object. Something like:
        ProbeContext_pa* ctx
 * which would be allocated/deallocated by the user.
 *
 ...
 * @param numPoints
 *   The number of points to probe
 *
 * @param x
 *   An array of X locations for the points to probe
 *
 * @param y
 *   An array of Y locations for the points to probe
 *
 * @param z
 *   An array of Z locations for the points to probe
 *
 * @param zoneSet
 *   The set of zones to probe for locations given by the X, Y and Z arrays
 *
 * @param varSet
 *   The variables to return from the probe actions
 *
 * @param probeNearest
 *   Indicates whether to probe for the position exactly, or find the nearest node
 *
 * @param obeyBlanking
 *   Indicates whether to avoid blanked regions while probing
 *
 * @param numNearestNodes
 *   The number of nearest nodes to consider in the probe
 *
 * @param tolerance
 *   The probe tolerance
 *
 * @param values
 *   The variable values returned by the probe
 *
 * @param cellsOrNodes
 *   The cells or nodes in which the specified positions were located
 *
 * @param planes
 *   The planes on which the specified positions were located
 *
 * @param zoneIndices
 *   The zones in which the specified positions were located
 *
 * @pre Current frame must have a data set with at least one zone.
 *
 * @pre <em>x</em>
 ...
 *   Pointer must be a valid address or NULL.
 *
 * @pre <em>obeyBlanking</em>
 *   Value must be TRUE or FALSE.
 *
 * @pre <em>values</em>
 *   Pointer must be a valid address or NULL.
 *
 * @pre <em>cellsOrNodes</em>
 *   Pointer must be a valid address or NULL.
 *
 * @pre <em>planes</em>
 *   Pointer must be a valid address or NULL.
 *
 * @pre <em>zoneIndices</em>
 *   Pointer must be a valid address or NULL.
 *
 *
 */
LINKTOADDON Boolean_t TecUtilProbeOnSurface(
    ...
    TP_ARRAY_OUT EntIndex_t*    zoneIndices) TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_GIVES LineSegProbeResult_pa TecUtilLineSegProbeResultAlloc() TP_DIRECT;
 ...
 *
 */
LINKTOADDON void TecUtilLineSegProbeResultDealloc(TP_RECEIVES_GIVES LineSegProbeResult_pa* LineSegProbeResult) TP_DIRECT;
 ...
 *
 */
LINKTOADDON void TecUtilLineSegProbeResultClear(TP_RECEIVES_GIVES LineSegProbeResult_pa LineSegProbeResult) TP_DIRECT;
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilLineSegProbe(LineSegProbeResult_pa   LineSegProbeResult,
 ...
 * @ingroup Probe
 */
LINKTOADDON int32_t TecUtilLineSegProbeResultGetCount(LineSegProbeResult_pa LineSegProbeResult) TP_DIRECT;
 ...
 * @ingroup Probe
 */
LINKTOADDON ProbeStatus_e TecUtilLineSegProbeGetStatus(LineSegProbeResult_pa LineSegProbeResult,
                                                                      int32_t               WhichSegment) TP_DIRECT;
 ...
 * @ingroup Probe
 */
LINKTOADDON double TecUtilLineSegProbeGetVarValue(LineSegProbeResult_pa LineSegProbeResult,
 ...
 * @ingroup Probe
 */
LINKTOADDON LgIndex_t TecUtilLineSegProbeGetICell(LineSegProbeResult_pa LineSegProbeResult,
                                                                 int32_t               WhichSegment) TP_DIRECT;
 ...
 * @ingroup Probe
 */
LINKTOADDON LgIndex_t TecUtilLineSegProbeGetJCell(LineSegProbeResult_pa LineSegProbeResult,
                                                                 int32_t               WhichSegment) TP_DIRECT;
 ...
 * @ingroup Probe
 */
LINKTOADDON LgIndex_t TecUtilLineSegProbeGetKCell(LineSegProbeResult_pa LineSegProbeResult,
                                                                 int32_t               WhichSegment) TP_DIRECT;
 ...
 * @ingroup Probe
 */
LINKTOADDON EntIndex_t TecUtilLineSegProbeGetZone(LineSegProbeResult_pa LineSegProbeResult,
                                                                 int32_t               WhichSegment) TP_DIRECT;
 ...
 * @ingroup Probe
 */
LINKTOADDON int32_t TecUtilLineSegProbeGetFace(LineSegProbeResult_pa LineSegProbeResult,
                                                              int32_t               WhichSegment) TP_DIRECT;
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilZoneGetEnabled(TP_GIVES Set_pa* EnabledZones) TP_DIRECT;
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilZoneGetEnabledByDataSetID(UniqueID_t       DataSetID,
                                                                      TP_GIVES Set_pa* EnabledZones) TP_DIRECT;
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilZoneGetEnabledForFrame(UniqueID_t       FrameID,
                                                                   TP_GIVES Set_pa* EnabledZones) TP_DIRECT;
 ...
 * @ingroup Zone
 */
LINKTOADDON Boolean_t TecUtilZoneGetRelevant(double           SolutionTime,
 ...
 *
 */
LINKTOADDON TP_GIVES Set_pa TecUtilDataSetGetRelevantZones(
 ...
 *
 */
LINKTOADDON TP_GIVES Set_pa TecUtilDataSetGetStrandRelevantZones(
    EntIndex_t StrandID,
    double   SolutionTimeMin,
    double   SolutionTimeMax);
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilVarGetEnabled(TP_GIVES Set_pa* EnabledVars) TP_DIRECT;
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilVarGetEnabledByDataSetID(UniqueID_t       DataSetID,
                                                                     TP_GIVES Set_pa* EnabledVars) TP_DIRECT;
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilVarGetEnabledForFrame(UniqueID_t       FrameID,
                                                                  TP_GIVES Set_pa* EnabledVars) TP_DIRECT;
/**
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilZoneGetActive(TP_GIVES Set_pa* ActiveZones);
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilZoneGetActiveForFrame(UniqueID_t FrameID,
 ...
 * #internalattributes exclude_python, exclude_sdkdoc
 */
LINKTOADDON Boolean_t TecUtilXYMapGetActive(TP_GIVES Set_pa* ActiveXYMaps);
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilLineMapGetActive(TP_GIVES Set_pa* ActiveLineMaps) TP_DIRECT;
 ...
 * #internalattributes exclude_python, exclude_sdkdoc
 */
LINKTOADDON void TecUtilXYMapGetAssignment(EntIndex_t                   XYMap,
 ...
 *
 */
LINKTOADDON void TecUtilLineMapGetAssignment(EntIndex_t               LineMap,
                                                            TP_OUT EntIndex_t*       Zone,
                                                            TP_OUT EntIndex_t*       XOrThetaVar,
                                                            TP_OUT EntIndex_t*       YOrRVar,
                                                            TP_OUT int32_t*          XAxis,
                                                            TP_OUT int32_t*          YAxis,
                                                            TP_OUT FunctionDependency_e* FunctionDependency) TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilZoneIsFiniteElement(EntIndex_t Zone) TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilZoneIsOrdered(EntIndex_t Zone) TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilZoneIsOrderedByDataSetID(UniqueID_t DataSetID,
                                                                              EntIndex_t Zone) TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilZoneIsOrderedForFrame(UniqueID_t FrameID,
                                                                           EntIndex_t Zone) TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilZoneIsSZL(EntIndex_t Zone) TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilZoneIsFEClassic(EntIndex_t Zone) TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilZoneIsFEPolytope(EntIndex_t Zone) TP_DIRECT;
 ...
 *
 */
LINKTOADDON ZoneType_e TecUtilZoneGetType(EntIndex_t Zone) TP_DIRECT;
 ...
 *
 */
LINKTOADDON ZoneType_e TecUtilZoneGetTypeByDataSetID(UniqueID_t dataSetID,
                                                                    EntIndex_t zone) TP_DIRECT;
 ...
 *
 */
LINKTOADDON double TecUtilDataValueGetByZoneVar(EntIndex_t Zone,
                                                               EntIndex_t Var,
                                                               LgIndex_t  ValueIndex) TP_DIRECT;
 ...
 * @ingroup DataValue
 */
LINKTOADDON FieldData_pa TecUtilDataValueGetReadableNativeRef(EntIndex_t Zone,
                                                                             EntIndex_t Var) TP_DIRECT;
 ...
 * @ingroup DataValue
 */
LINKTOADDON FieldData_pa TecUtilDataValueGetReadableNativeRefByUniqueID(UniqueID_t DatasetID,
                                                                                       EntIndex_t Zone,
                                                                                       EntIndex_t Var) TP_DIRECT;
 ...
 * @ingroup DataValue
 */
LINKTOADDON FieldData_pa TecUtilDataValueGetReadableDerivedRef(EntIndex_t Zone,
                                                                              EntIndex_t Var) TP_DIRECT;
 ...
 * @ingroup DataValue
 */
LINKTOADDON FieldData_pa TecUtilDataValueGetReadableNLRef(EntIndex_t Zone,
                                                                         EntIndex_t Var) TP_DIRECT;
 ...
 * @ingroup DataValue
 */
LINKTOADDON FieldData_pa TecUtilDataValueGetReadableCCRef(EntIndex_t Zone,
                                                                         EntIndex_t Var) TP_DIRECT;
 ...
 *
 */
LINKTOADDON FieldData_pa TecUtilDataValueGetWritableNativeRefByUniqueID(UniqueID_t DatasetID,
                                                                                       EntIndex_t Zone,
                                                                                       EntIndex_t Var) TP_DIRECT;
 ...
 *
 */
LINKTOADDON FieldData_pa TecUtilDataValueGetWritableNativeRef(EntIndex_t Zone,
                                                                             EntIndex_t Var) TP_DIRECT;
 ...
 * #internalattributes exclude_python, exclude_sdkdoc
 */
LINKTOADDON FieldData_pa TecUtilDataValueGetWritableRef(EntIndex_t Zone,
                                                                       EntIndex_t Var) TP_DIRECT;
 ...
 * #internalattributes exclude_python, exclude_sdkdoc
 */
LINKTOADDON FieldData_pa TecUtilDataValueGetReadableRef(EntIndex_t Zone,
                                                                       EntIndex_t Var) TP_DIRECT;
 ...
 * #internalattributes exclude_python, exclude_sdkdoc
 */
LINKTOADDON FieldData_pa TecUtilDataValueGetRef(EntIndex_t Zone,
                                                               EntIndex_t Var) TP_DIRECT;
 ...
 */
LINKTOADDON FieldValueGetFunction_pf TecUtilDataValueRefGetGetFunc(FieldData_pa FD) TP_DIRECT;
 ...
 *   FieldValueSetFunction_pf setFunction = TecUtilDataValueRefGetSetFunc(fd);
 *   for ( pt = 0; pt < 21; pt++ ) // use =0 and <21 becaused setFunction is 0-based
 ...
 * #internalattributes exclude_fglue, exclude_tcl
 */
LINKTOADDON FieldValueSetFunction_pf TecUtilDataValueRefGetSetFunc(FieldData_pa FD) TP_DIRECT;
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilDataValueGetZoneVarByRef(FieldData_pa       FD,
                                                      TP_OUT EntIndex_t* Zone,
                                                      TP_OUT EntIndex_t* Var) TP_DIRECT;
/**
 * Get the low-level "get value" function associated with a node map
 * data handle. In general, using this function is faster than calling
 * TecUtilDataNodeGetByRef().
 * This function is \ref threadsafe.
 *
 ...
 * @par Note:
 *   Do not assume that raw data internal to Tecplot remain in the same
 *   location at all times. Always re-fetch the node map data reference and
 *   subsequently the "get value" function after any major event as Tecplot may
 *   move/alter the raw data. Make sure to call TecUtilStateChanged() after any
 *   node map values have changed.
 *
 * @param nodeMap
 *   A node map data reference usually obtained via a call to one of the following
 *   functions: TecUtilDataNodeGetReadableRef() or TecUtilDataNodeGetWritableRef().
 *
 * @return
 *   The low-level "get value" function associated with a node map data handle.
 *   This function takes zero-based values and has no assertions associated
 *   with it.
 *
 *
 ...
 * #internalattributes exclude_fglue, exclude_tcl
 */
LINKTOADDON NodeMapGetValue_pf TecUtilDataNodeRefGetGetFunc(NodeMap_pa nodeMap);

/**
 * Get the low-level "set value" function associated with a node map
 * data handle. In general, using this function is faster than calling
 ...
 *   Do not assume that raw data internal to Tecplot remain in the same
 *   location at all times. Always re-fetch the node map data reference and
 *   subsequently the "set value" function after any major event as Tecplot may
 *   move/alter the raw data. Make sure to call TecUtilStateChanged() after any
 *   node map values have changed.
 *
 * @param nodeMap
 *   A node map data reference usually obtained via a call to one of the following
 *   functions: TecUtilDataNodeGetWritableRef().
 *
 * @return
 *   The low-level "set value" function associated with a node map data handle.
 *   This function takes zero-based values and has no assertions associated
 *   with it.
 *
 *
 ...
 * #internalattributes exclude_fglue, exclude_tcl
 */
LINKTOADDON NodeMapSetValue_pf TecUtilDataNodeRefGetSetFunc(NodeMap_pa nodeMap);
 ...
 * @ingroup DataServices
 */
LINKTOADDON NodeMap_pa TecUtilDataNodeGetReadableRef(EntIndex_t Zone) TP_DIRECT;
 ...
 * @ingroup DataServices
 */
LINKTOADDON NodeMap_pa TecUtilDataNodeGetWritableRef(EntIndex_t Zone) TP_DIRECT;
 ...
 * #internalattributes exclude_python, exclude_sdkdoc
 */
LINKTOADDON NodeMap_pa TecUtilDataNodeGetRef(EntIndex_t Zone) TP_DIRECT;
 ...
 * #internalattributes exclude_python, exclude_sdkdoc
 */
LINKTOADDON FaceNeighbor_pa TecUtilDataFaceNbrGetRef(EntIndex_t Zone) TP_DIRECT;
 ...
 *
 */
LINKTOADDON FieldDataType_e TecUtilDataValueGetRefType(FieldData_pa FieldData) TP_DIRECT;
 ...
 *
 */
LINKTOADDON FieldDataType_e TecUtilDataValueGetType(EntIndex_t Zone,
                                                                   EntIndex_t Var) TP_DIRECT;
 ...
 *
 */
LINKTOADDON ValueLocation_e TecUtilDataValueGetLocation(EntIndex_t Zone,
                                                                       EntIndex_t Var) TP_DIRECT;
 ...
 */
LINKTOADDON ValueLocation_e TecUtilDataValueGetLocationByRef(FieldData_pa FieldData) TP_DIRECT;
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilImportGetLoaderInstr(TP_GIVES char**         DataSetLoaderName,
                                                          TP_GIVES StringList_pa* DataSetLoaderInstructions);
 ...
 * @ingroup UserInterface
 */
LINKTOADDON Boolean_t TecUtilDialogMessageBox(const char       *Message,
                                                             MessageBoxType_e  MessageBoxType) TP_DIRECT;
 ...
 * @ingroup UserInterface
 */
LINKTOADDON Boolean_t TecUtilDialogLastMessageBox() TP_DIRECT;
 ...
 */
LINKTOADDON Boolean_t TecUtilDialogGetSimpleText(const char*     Instructions,
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilMacroFunctionExists(const char *FunctionName);
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilMacroIsBatchModeActive() TP_DIRECT;
 ...
 * #internalattributes exclude_sdkdoc
 */
LINKTOADDON void TecUtilInterfaceGetDotsPerInch(TP_OUT double* VDotsPerInch,
 ...
 */
LINKTOADDON int32_t TecUtilInterfaceGetBaseFontSize();

/**
 * Fetch an Array of values by reference.
 * This function fetches the specified number of values from the source field
 * data starting at the specified source item index and copies them to the
 ...
 * @param SourceIndex
 *     Ones based member index in the source field data to begin fetching values.
 * @param SourceCount
 ...
 *
 */
LINKTOADDON void TecUtilDataValueArrayGetByRef(FieldData_pa       SourceFieldData,
                                               LgIndex_t          SourceIndex,
                                               LgIndex_t          SourceCount,
                                               TP_ARRAY_OUT void* DestValueArray) TP_DIRECT;
/**
 ...
 *
 */
LINKTOADDON double TecUtilDataValueGetByRef(FieldData_pa FieldData,
                                                           LgIndex_t    PointIndex) TP_DIRECT;
/**
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilDataValueIsMinMaxValidByZoneVar(EntIndex_t Zone,
                                                                                     EntIndex_t Var) TP_DIRECT;
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilDataValueGetMinMaxByZoneVar(EntIndex_t     Zone,
                                                                 EntIndex_t     Var,
                                                                 TP_OUT double* Min,
                                                                 TP_OUT double* Max);
 ...
 * @ingroup DataValue
 */
LINKTOADDON void TecUtilDataValueGetMinMaxByRef(FieldData_pa   FieldData,
                                                               TP_OUT double* Min,
                                                               TP_OUT double* Max) TP_DIRECT;
/**
 ...
 *
 */
LINKTOADDON NodeMap_t TecUtilDataNodeGetByZone(EntIndex_t Zone,
                                                              LgIndex_t  Element,
                                                              int32_t    Corner) TP_DIRECT;

/**
 * Fetch an array of nodes by reference.
 * This function fetches the specified number of nodes from the source node
 * map starting at the specified source item index and copies them to the
 ...
 * @param SourceIndex
 *   Ones based node index in the source node map to begin fetching nodes.
 * @param SourceCount
 ...
 *
 */
LINKTOADDON void TecUtilDataNodeArrayGetByRef(NodeMap_pa         SourceNodeMap,
                                              LgIndex_t          SourceIndex,
                                              LgIndex_t          SourceCount,
                                              TP_ARRAY_OUT void* DestNodeArray) TP_DIRECT;

/**
 * Fetches the ones based, 32-bit nodes of the connectivity from the underlying section of the
 * FE-mixed element nodemap. Within a section all elements have homogeneous cell shape, grid order,
 * and basis function. For each element the linear and high-order nodes are interleaved, where the
 * linear nodes are expressed first, immediately followed by the high-order nodes.
 *
 * This function is \ref threadsafe.
 *
 * @note
 ...
 *     zone types.
 * @param index
 *     Ones based beginning node index in the array specified by sectionIndex in the node map.
 * @param count
 *     Number of nodes to access in the destination node map array. This value must not exceed the
 *     size of nodeArray.
 * @param nodeArray
 *     An int32_t array to receive the one based, 32-bit nodes. The first node is assumed to be at
 *     the base of the array. The nodeArray must have enough space to accommodate the requested
 *     portion of the connectivity. If any node values of the connectivity require 64-bit integers
 *     then you must use TecUtilDataNodeSectionArrayGetByRef64() instead.
 *
 *
 * @pre <em>nodeMap</em>
 *   Pointer must be a valid address and non-NULL.
 ...
 *
 *
 * @sa TecUtilDataNodeGetReadableRef()
 * @sa TecUtilDataNodeGetRawItemType()
 * @sa TecUtilDataNodeSectionArrayGetByRef64()
 *
 * @ingroup DataStructure
 */
LINKTOADDON void TecUtilDataNodeSectionArrayGetByRef(NodeMap_pa            nodeMap,
                                                     EntIndex_t            sectionIndex,
                                                     LgIndex_t             index,
                                                     LgIndex_t             count,
                                                     TP_ARRAY_OUT int32_t* nodeArray);

/**
 * Fetches the ones based, 64-bit nodes of the connectivity from the underlying section of the
 * FE-mixed element nodemap. Within a section all elements have homogeneous cell shape, grid order,
 * and basis function. For each element the linear and high-order nodes are interleaved, where the
 * linear nodes are expressed first, immediately followed by the high-order nodes.
 *
 ...
 *     size of nodeArray.
 * @param nodeArray
 *     An int64_t array to receive the one based, 64-bit nodes. The first node is assumed to be at
 *     the base of the array. The nodeArray must have enough space to accommodate the requested
 *     portion of the connectivity. If no node values of the connectivity require 64-bit integers
 *     then you must use TecUtilDataNodeSectionArrayGetByRef() instead.
 *
 *
 * @pre <em>nodeMap</em>
 *   Pointer must be a valid address and non-NULL.
 ...
 * @sa TecUtilDataNodeGetReadableRef()
 * @sa TecUtilDataNodeGetRawItemType()
 * @sa TecUtilDataNodeSectionArrayGetByRef()
 *
 * @ingroup DataStructure
 */
LINKTOADDON void TecUtilDataNodeSectionArrayGetByRef64(NodeMap_pa            nodeMap,
                                                       EntIndex_t            sectionIndex,
                                                       LgIndex_t             index,
                                                       LgIndex_t             count,
                                                       TP_ARRAY_OUT int64_t* nodeArray);

/**
 * Gets the 32 bit raw pointer for the cell nodes from the readable or writable finite-element node
 * map. Within a section all elements have homogeneous cell shape, grid order, and basis function.
 * For each element the linear and high-order nodes are interleaved, where the linear nodes are
 * expressed first, immediately followed by the high-order nodes. This function must only be used if
 * the underlying data type for the node map is 32-bit integers. If the underlying data type is
 * 64-bit integers, use TecUtilDataNodeSectionGetRawPtrByRef64().
 * See TecUtilDataNodeGetRawItemType() for additional information.
 *
 * This function is \ref threadsafe.
 *
 ...
 *     zone types.
 * @return
 *     The address of the raw node map for the cell nodes.
 *
 *
 * @pre <em>nodeMap</em>
 *   Pointer must be a valid address and non-NULL.
 ...
 *
 * @sa TecUtilDataNodeGetRawItemType()
 * @sa TecUtilDataNodeSectionGetRawPtrByRef64()
 */
LINKTOADDON int32_t* TecUtilDataNodeSectionGetRawPtrByRef(NodeMap_pa nodeMap,
                                                          EntIndex_t sectionIndex) TP_DIRECT;

/**
 * Gets the 64 bit raw pointer for the cell nodes from the readable or writable finite-element node
 * map. Within a section all elements have homogeneous cell shape, grid order, and basis function.
 * For each element the linear and high-order nodes are interleaved, where the linear nodes are
 * expressed first, immediately followed by the high-order nodes. This function must only be used if
 * the underlying data type for the node map is 64-bit integers. If the underlying data type is
 * 32-bit integers, use TecUtilDataNodeSectionGetRawPtrByRef().
 * See TecUtilDataNodeGetRawItemType() for additional information.
 *
 * This function is \ref threadsafe.
 *
 ...
 *     zone types.
 * @return
 *     The address of the raw node map for either the linear or high-order nodes.
 *
 *
 * @pre <em>nodeMap</em>
 *   Pointer must be a valid address and non-NULL.
 ...
 *
 * @sa TecUtilDataNodeGetRawItemType()
 * @sa TecUtilDataNodeSectionGetRawPtrByRef()
 */
LINKTOADDON int64_t* TecUtilDataNodeSectionGetRawPtrByRef64(NodeMap_pa nodeMap,
                                                            EntIndex_t sectionIndex) TP_DIRECT;
 ...
 *
 */
LINKTOADDON NodeMap_t TecUtilDataNodeGetByRef(NodeMap_pa NodeMapPtr,
                                                             LgIndex_t  Element,
                                                             int32_t    Corner) TP_DIRECT;
/**
 ...
 *
 */
LINKTOADDON int32_t TecUtilDataNodeGetNodesPerElem(NodeMap_pa NodeMapPtr) TP_DIRECT;
 ...
 * #internalattributes exclude_python, exclude_sdkdoc
 */
LINKTOADDON LgIndex_t TecUtilDataFaceNbrGetByZone(EntIndex_t Zone,
                                                                 LgIndex_t  Element,
                                                                 int32_t    Face) TP_DIRECT;
/**
 * @deprecated
 *   Please use TecUtilDataFaceNbrGetNbrByRef() instead.
 *
 ...
 * #internalattributes exclude_python, exclude_sdkdoc
 */
LINKTOADDON LgIndex_t TecUtilDataFaceNbrGetByRef(FaceNeighbor_pa FaceNeighbor,
                                                                LgIndex_t       Element,
                                                                int32_t         Face) TP_DIRECT;
 ...
 *
 */
LINKTOADDON FaceNeighborMode_e TecUtilDataFaceNbrGetModeByZone(EntIndex_t Zone) TP_DIRECT;

/**
 * Returns the zone unique ID associated with this face neighbor referenced.
 * This function is \ref threadsafe.
 *
 * @param FaceNeighbor
 *     The face neighbor handle to a zone in the data set attached to the current frame.
 *
 * @return
 *     Unique ID of the zone associated with this face neighbor reference.
 *
 * @since
 *     2021.2
 *
 * <FortranSyntax>
 *    INTEGER*8 FUNCTION TecUtilDataFaceNbrGetZoneUniqueIDByRef(FaceNeighborPtr)
 ...
 * @ingroup FaceNeighbors
 */
LINKTOADDON UniqueID_t TecUtilDataFaceNbrGetZoneUniqueIDByRef(FaceNeighbor_pa FaceNeighbor) TP_DIRECT;
 ...
 *
 */
LINKTOADDON FaceNeighborMode_e TecUtilDataFaceNbrGetModeByRef(FaceNeighbor_pa FaceNeighbor) TP_DIRECT;
 ...
 *
 */
LINKTOADDON int32_t TecUtilDataFaceNbrGetNumNByRef(FaceNeighbor_pa   FaceNeighbor,
                                                                  LgIndex_t         Element,
                                                                  int32_t           Face,
                                                                  TP_OUT Boolean_t* NeighborsAreUserSpecified) TP_DIRECT;
 ...
 *
 * @param Section
 *   The one-based section number, must be 1 for classic FE data.
 *
 * @param Element
 *   The element number (starts at one)
 *
 ...
 *
 */
LINKTOADDON int32_t TecUtilDataFaceNbrGetNumNBySectionByRef(
 ...
 *
 */
LINKTOADDON void TecUtilDataFaceNbrGetNbrByRef(FaceNeighbor_pa    FaceNeighbor,
                                                              LgIndex_t          Element,
                                                              int32_t            Face,
                                                              int32_t            NeighborNumber,
                                                              TP_OUT LgIndex_t*  NeighborElem,
                                                              TP_OUT EntIndex_t* NeighborZone) TP_DIRECT;
 ...
 *
 */
LINKTOADDON void TecUtilDataFaceNbrGetNbrBySectionByRef(
    FaceNeighbor_pa    FaceNeighbor,
    EntIndex_t         section,
    LgIndex_t          Element,
    int32_t            Face,
    int32_t            NeighborNumber,
    TP_OUT LgIndex_t*  NeighborElem,
    TP_OUT EntIndex_t* neighborSection,
    TP_OUT EntIndex_t* NeighborZone) TP_DIRECT;
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilDataFaceNbrBeginAssignX(ArgList_pa ArgList);
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilDataFaceNbrBeginAssign(EntIndex_t Zone);
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilDataFaceNbrAssign(LgIndex_t   Element,
                                               int32_t     Face,
                                               Boolean_t   NeighborsCompletelyObscure,
                                               int32_t     NumNeighbors,
                                               int32_t*    NeighborElems,
                                               UniqueID_t* NeighborZoneUniqueIds);
 ...
 * @ingroup FaceNeighbors
 */
LINKTOADDON void TecUtilDataFaceNbrArrayAssign(LgIndex_t  DestIndex,
                                               LgIndex_t  DestCount,
                                               int32_t   *NeighborElems);
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilDataFaceNbrEndAssign();
 ...
 * @ingroup DataServices
 */
LINKTOADDON ArbParam_t TecUtilDataFaceNbrGetClientData(FaceNeighbor_pa FaceNeighbor) TP_DIRECT;
 ...
 * @ingroup DataServices
 */
LINKTOADDON Boolean_t TecUtilDataFaceNbrCustomLOD(EntIndex_t                         Zone,
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilDataFaceNbrFaceIsObscured(
    FaceNeighbor_pa FaceNeighbor,
    LgIndex_t Element,
    int32_t   Face,
    Set_pa ActiveZones) TP_DIRECT;
 ...
 * @ingroup DataServices
 */
LINKTOADDON FaceNeighbor_pa TecUtilDataFaceNbrGetReadableRef(EntIndex_t Zone) TP_DIRECT;
 ...
 * assignment sequence starting at the specified destination index. The face
 ...
 *     callback.
 * @param DestIndex
 *     Ones based index in Tecplot's face neighbor array to begin assigning the supplied
 *     neighbor elements.
 * @param NumNeighbors
 ...
 *     type must match the internal type as returned by TecUtilDataFaceNbrRawItemType()).
 ...
 * @ingroup DataServices
 */
LINKTOADDON void TecUtilDataFaceNbrAssignArrayByRef(FaceNeighbor_pa  FaceNeighbor,
                                                    LgIndex_t        DestIndex,
                                                    int32_t          NumNeighbors,
                                                    const int32_t*   NeighborElems) TP_DIRECT;
 ...
 * @ingroup DataServices
 */
LINKTOADDON void TecUtilDataFaceNbrAssignArrayByRef64(FaceNeighbor_pa  FaceNeighbor,
                                                      LgIndex_t        DestIndex,
                                                      int32_t          NumNeighbors,
                                                      const int64_t*   NeighborElems) TP_DIRECT;
 ...
 *   Array of 32-bit integers.  If the internal type (see TecUtilDataFaceNbrRawItemType())
 *   requires 64-bit integers you must use TecUtilDataFaceNbrAssignByRef64() instead.
 * @param NeighborZoneUniqueIds
 *   Array containing the zone unique IDs of the neighbors for global
 ...
 *    INTEGER*8       NeighborZoneUniqueIds
 * </FortranSyntax>
 *
 * <PythonSyntax>
 * </PythonSyntax>
 ...
 * @ingroup DataServices
 */
LINKTOADDON Boolean_t TecUtilDataFaceNbrAssignByRef(FaceNeighbor_pa   FaceNeighbor,
                                                    LgIndex_t         Element,
                                                    int32_t           Face,
                                                    Boolean_t         NbrsCompObscure,
                                                    int32_t           NumNeighbors,
                                                    const int32_t*    NeighborElems,
                                                    const UniqueID_t* NeighborZoneUniqueIds) TP_DIRECT;
 ...
 * @param NeighborElems
 *   Array containing the one based element numbers of the neighbors.
 *   Array of 64-bit integers.  If the internal type (see TecUtilDataFaceNbrRawItemType())
 ...
 * @ingroup DataServices
 */
LINKTOADDON Boolean_t TecUtilDataFaceNbrAssignByRef64(FaceNeighbor_pa   FaceNeighbor,
                                                      LgIndex_t         Element,
                                                      int32_t           Face,
                                                      Boolean_t         NbrsCompObscure,
                                                      int32_t           NumNeighbors,
 ...
 * #internalattributes exclude_python, exclude_sdkdoc
 */
LINKTOADDON EntIndex_t TecUtilXYMapGetCount() TP_DIRECT;
 ...
 *
 */
LINKTOADDON EntIndex_t TecUtilLineMapGetCount() TP_DIRECT;
 ...
 *
 */
LINKTOADDON EntIndex_t TecUtilLineMapGetCountForFrame(UniqueID_t FrameID) TP_DIRECT;
 ...
 *
 */
LINKTOADDON EntIndex_t TecUtilFieldMapGetCount();
 ...
 *
 */
LINKTOADDON EntIndex_t TecUtilFieldMapGetCountForFrame(UniqueID_t FrameID);
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilFieldMapGetActive(TP_GIVES Set_pa* ActiveFieldMaps);
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilFieldMapIsActiveForFrame(UniqueID_t FrameID,
                                                              EntIndex_t FieldMap);
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilFieldMapIsActive(EntIndex_t FieldMap);
 ...
 *
 */
LINKTOADDON FieldMapMode_e TecUtilFieldMapGetModeForFrame(UniqueID_t
 ...
 *
 */
LINKTOADDON FieldMapMode_e TecUtilFieldMapGetMode(EntIndex_t FieldMap);

/**
 * Returns the strand ID associated with the fieldmap in a frame or 0 if the field map mode is
 ...
 *     Number of the field map.
 * @return
 *     The strand ID associated with the fieldmap in a frame or 0.
 *
 * <FortranSyntax>
 *    INTEGER*4 FUNCTION TecUtilFieldMapGetStrandID(frameID, fieldMap)
 *    INTEGER*8 frameID
 *    INTEGER*4 fieldMap
 * </FortranSyntax>
 *
 ...
 * @ingroup FieldMap
 */
LINKTOADDON EntIndex_t TecUtilFieldMapGetStrandID(UniqueID_t frameID,
                                                  EntIndex_t fieldMap);
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilFieldMapGetZones(EntIndex_t       FieldMap,
                                                      TP_GIVES Set_pa* Zones);

/**
 * Returns the number of the candidate zone for the fieldmap in the given frame or TECUTILBADID if
 * no suitable zone is relevant.
 *
 * @param FrameID
 *   Unique ID of a frame for which field map count should be returned.
 * @param FieldMap
 *   Number of the field map.
 * @return
 *   Zone number or TECUTILBADID if not suitable zone is relevant.
 *
 * <FortranSyntax>
 ...
 *
 */
LINKTOADDON EntIndex_t TecUtilFieldMapGetCandidateZoneForFrame(UniqueID_t FrameID, EntIndex_t FieldMap);

/**
 * Returns the number of the candidate zone for the fieldmap in the active frame or TECUTILBADID if
 * no suitable zone is relevant.
 *
 * @param FieldMap
 *   Number of the field map.
 ...
 *
 */
LINKTOADDON EntIndex_t TecUtilFieldMapGetCandidateZone(EntIndex_t FieldMap);
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilFieldMapIsRelevant(EntIndex_t FieldMap);
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilFieldMapHasOrderedZonesForFrame(UniqueID_t FrameID,
                                                                     EntIndex_t FieldMap);
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilFieldMapHasOrderedZones(EntIndex_t FieldMap);
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilFieldMapHasIJKOrderedZonesForFrame(UniqueID_t FrameID,
                                                                        EntIndex_t FieldMap);
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilFieldMapHasIJKOrderedZones(EntIndex_t FieldMap);
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilFieldMapHasFEZones(EntIndex_t FieldMap);
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilFieldMapHasVolumeZones(EntIndex_t FieldMap);
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilFieldMapHasVolumeZonesForFrame(UniqueID_t FrameID,
                                                                    EntIndex_t FieldMap);
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilFieldMapHasSurfaceZones(EntIndex_t FieldMap);
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilFieldMapHasLinearZones(EntIndex_t FieldMap);
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilUserMacroIsRecordingActive() TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilMacroIsRecordingActive() TP_DIRECT;
 ...
 *
 */
LINKTOADDON LgIndex_t TecUtilLimitGetValue(const char *LimitString);
 ...
 * @ingroup DataSetInfo
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilDataSetIsAvailableByUniqueID(UniqueID_t UniqueID) TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilDataSetIsAvailableForFrame(UniqueID_t FrameID) TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilDataSetIsAvailable() TP_DIRECT;
...
*
*/
LINKTOADDON TP_QUERY Boolean_t TecUtilDataSetIsUsedInLayout() TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilVarIsEnabledByDataSetID(UniqueID_t DataSetID,
                                                                             EntIndex_t Var) TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilVarIsEnabledForFrame(UniqueID_t FrameID,
                                                                          EntIndex_t Var) TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilVarIsEnabled(EntIndex_t Var) TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilZoneIsEnabled(EntIndex_t Zone) TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilZoneIsEnabledByDataSetID(UniqueID_t DataSetID,
                                                                              EntIndex_t Zone) TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilZoneIsActive(EntIndex_t Zone) TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilZoneIsActiveForFrame(UniqueID_t FrameID, EntIndex_t Zone) TP_DIRECT;
 ...
 * #internalattributes exclude_python, exclude_sdkdoc
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilXYMapIsActive(EntIndex_t XYMap) TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilLineMapIsActiveForFrame(UniqueID_t FrameID,
                                                                             EntIndex_t LineMap) TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilLineMapIsActive(EntIndex_t LineMap) TP_DIRECT;
 ...
 * #internalattributes exclude_python, exclude_sdkdoc
 */
LINKTOADDON Boolean_t TecUtilGetTempFileName(TP_GIVES char** TempFileName) TP_DIRECT;
 ...
 * @ingroup Utilities
 */
LINKTOADDON Boolean_t TecUtilFileGetTempName(TP_GIVES char** TempFileName) TP_DIRECT;
 ...
 * @ingroup Utilities
 */
LINKTOADDON Boolean_t TecUtilFileGetTempDirName(TP_GIVES char** TempDirName) TP_DIRECT;
 ...
 *
 */
LINKTOADDON void TecUtilColorMapGetBasicColorRGB(int32_t         BasicColor,
                                                         TP_OUT uint8_t* Red,
 ...
 *
 * @param contourColorIndex
 *   Ones based index of contour color to query. The value must be between 1 and
 *   number of contour shades (GeneralBase.Limits.MaxNumContourLevels + 1), inclusive.
 *
 * @param Red
 ...
 *
 */
LINKTOADDON void TecUtilColorMapGetContourRGB(int32_t         colorMapNumber,
                                              int32_t         contourColorIndex,
                                              TP_OUT uint8_t* Red,
                                              TP_OUT uint8_t* Green,
                                              TP_OUT uint8_t* Blue);
 ...
 *
 */
LINKTOADDON int32_t TecUtilColorMapNumBasicColors();
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilAutoRedrawIsActive();
 ...
 * @ingroup AuxData
 */
LINKTOADDON void TecUtilAuxDataBeginAssign();
 ...
 * @ingroup AuxData
 */
LINKTOADDON void TecUtilAuxDataEndAssign();
 ...
 * #internalattributes exclude_alldoc
 */
LINKTOADDON void TecUtilAuxDataDealloc(TP_RECEIVES AuxData_pa* AuxData) TP_DIRECT;
...
* @since 16.1
*/
LINKTOADDON AuxData_pa TecUtilAuxDataLayoutGetRef() TP_DIRECT;
 ...
 *
 */
LINKTOADDON AuxData_pa TecUtilAuxDataDataSetGetRef() TP_DIRECT;
 ...
 *
 */
LINKTOADDON AuxData_pa TecUtilAuxDataLineMapGetRef(EntIndex_t Map) TP_DIRECT;
 ...
 *
 */
LINKTOADDON AuxData_pa TecUtilAuxDataPageGetRef() TP_DIRECT;
 ...
 *
 */
LINKTOADDON AuxData_pa TecUtilAuxDataFrameGetRef() TP_DIRECT;
 ...
 *
 */
LINKTOADDON AuxData_pa TecUtilAuxDataZoneGetRef(EntIndex_t Zone) TP_DIRECT;
 ...
 *
 */
LINKTOADDON AuxData_pa TecUtilAuxDataVarGetRef(EntIndex_t Var) TP_DIRECT;
 ...
 *
 */
LINKTOADDON int32_t TecUtilAuxDataGetNumItems(AuxData_pa AuxDataRef) TP_DIRECT;
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilAuxDataGetItemIndex(AuxData_pa      AuxDataRef,
                                                                const char*     Name,
                                                                TP_OUT int32_t* ItemIndex) TP_DIRECT;
 ...
 *
 */
LINKTOADDON void TecUtilAuxDataGetStrItemByIndex(AuxData_pa        AuxDataRef,
                                                         int32_t           Index,
                                                         TP_GIVES char**   Name,
                                                         TP_GIVES char**   Value,
                                                         TP_OUT Boolean_t* Retain) TP_DIRECT;
 ...
 */
LINKTOADDON void TecUtilAuxDataGetItemByIndex(AuxData_pa            AuxDataRef,
                                                             int32_t               Index,
                                                             TP_GIVES char**       Name,
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilAuxDataGetStrItemByName(AuxData_pa        AuxDataRef,
                                                             const char*       Name,
                                                             TP_GIVES char**   Value,
                                                             TP_OUT Boolean_t* Retain) TP_DIRECT;
/**
 ...
 * #internalattributes exclude_fglue
 */
LINKTOADDON Boolean_t TecUtilAuxDataGetItemByName(AuxData_pa            AuxDataRef,
                                                                 const char*           Name,
                                                                 TP_GIVES ArbParam_t*  Value,
                                                                 TP_OUT AuxDataType_e* Type,
                                                                 TP_OUT Boolean_t*     Retain) TP_DIRECT;
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilAuxDataSetStrItem(AuxData_pa  AuxDataRef,
                                                       const char *Name,
                                                       const char *Value,
                                                       Boolean_t   Retain) TP_DIRECT;
/**
 ...
 * #internalattributes exclude_fglue
 */
LINKTOADDON Boolean_t TecUtilAuxDataSetItem(AuxData_pa     AuxDataRef,
                                                           const char    *Name,
                                                           ArbParam_t     Value,
                                                           AuxDataType_e  Type,
                                                           Boolean_t      Retain) TP_DIRECT;
 ...
 *
 */
LINKTOADDON void TecUtilAuxDataDeleteItemByIndex(AuxData_pa AuxDataRef,
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilAuxDataDeleteItemByName(AuxData_pa  AuxDataRef,
                                                                    const char *Name) TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilDataSetIsSharingAllowed() TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilDataValueIsSharingOk(EntIndex_t SourceZone,
                                                                          EntIndex_t DestZone,
                                                                          EntIndex_t Var) TP_DIRECT;
/**
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilDataConnectIsSharingOk(EntIndex_t SourceZone,
                                                                            EntIndex_t DestZone) TP_DIRECT;
 ...
 * @ingroup Zone
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilDataConnectIsSZLData(EntIndex_t Zone) TP_DIRECT;
 ...
 * @ingroup DataValue
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilVarRangeIsEstimated(EntIndex_t Zone,
                                                                         EntIndex_t Var) TP_DIRECT;
/**
 ...
 * @ingroup DataValue
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilVarIsSZLData(EntIndex_t Zone,
                                                                  EntIndex_t Var) TP_DIRECT;
 ...
 * @ingroup DataValue
 */
LINKTOADDON EntIndex_t TecUtilDataValueGetPrevSharedZone(Set_pa     ZonesToConsider,
                                                                        EntIndex_t Zone,
                                                                        EntIndex_t Var) TP_DIRECT;
/**
 ...
 *
 */
LINKTOADDON TP_GIVES Set_pa TecUtilDataValueGetShareZoneSet(EntIndex_t Zone,
                                                                           EntIndex_t Var) TP_DIRECT;
 ...
 * @ingroup DataSharing
 */
LINKTOADDON EntIndex_t TecUtilConnectGetPrevSharedZone(Set_pa     ZonesToConsider,
                                                                      EntIndex_t Zone) TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_GIVES Set_pa TecUtilConnectGetShareZoneSet(EntIndex_t Zone) TP_DIRECT;
 ...
 *
 */
LINKTOADDON EntIndex_t TecUtilDataValueGetShareCount(EntIndex_t Zone,
                                                                    EntIndex_t Var) TP_DIRECT;
/**
 ...
 *
 */
LINKTOADDON EntIndex_t TecUtilDataConnectGetShareCount(EntIndex_t Zone) TP_DIRECT;
 ...
 * #internalattributes exclude_alldoc
 */
LINKTOADDON AppMode_e       TecUtilTecplotGetAppMode();
 ...
 * #internalattributes exclude_alldoc
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilFeatureIsEnabled(FeatureFlag_t   featureId,
                                                               TP_GIVES char** reason) TP_DIRECT;
 ...
 *
 * @return
 *   FALSE if an allocation error occurred otherwise TRUE.
 *
 *
 * @pre <em>NumLevels</em>
 *   Pointer must be a valid address and non-NULL.
 ...
 * #internalattributes exclude_tcl
 */
LINKTOADDON Boolean_t TecUtilContourGetLevels(int32_t                 ContourGroup,
 ...
 * @ingroup Contour
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilQueryColorBandsInUseForContourGroup(int32_t ContourGroup);
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilDataSetIsLODAllowed() TP_DIRECT;
 ...
 *
 */
LINKTOADDON double TecUtilZoneGetSolutionTime(EntIndex_t Zone) TP_DIRECT;
 ...
 *
 */
LINKTOADDON EntIndex_t TecUtilZoneGetStrandID(EntIndex_t Zone) TP_DIRECT;
 ...
 *
 */
LINKTOADDON EntIndex_t TecUtilZoneGetStrandIDByDataSetID(UniqueID_t dataSetID,
                                                                        EntIndex_t zone) TP_DIRECT;

/**
 * @deprecated
 *   Tecplot no longer uses the parent zone designation for generating no-slip surface streamtraces.
 *
 * @ingroup Zone
 *
 */
LINKTOADDON EntIndex_t TecUtilZoneGetParentZone(EntIndex_t Zone) TP_DIRECT;
 ...
 *
 */
LINKTOADDON EntIndex_t TecUtilZoneGetFieldMap(EntIndex_t Zone) TP_DIRECT;
 ...
 *
 */
LINKTOADDON double TecUtilSolutionTimeGetCurrent() TP_DIRECT;

/**
 * Returns the minimum solution time for the dataset of the current frame based
 * on the dataset's solution time clustering options.
 * This function is \ref threadsafe.
 *
 * @since
 *     12.1.1.8018
 ...
 *
 */
LINKTOADDON double TecUtilSolutionTimeGetMin();

/**
 * Returns the maximum solution time for the dataset of the current frame based
 * on the dataset's solution time clustering options.
 * This function is \ref threadsafe.
 *
 * @return
 ...
 *
 */
LINKTOADDON double TecUtilSolutionTimeGetMax();

/**
 * Returns the number of unique solution times in a dataset based on the
 * dataset's solution time clustering options.
 * This function is \ref threadsafe.
 *
 * @since
 *     2017.2
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilSolutionTimeGetNumTimeStepsByDataSetID(UniqueID_t         dataSetID,
                                                                    TP_OUT EntIndex_t* numTimeSteps);

/**
 * Gets the number of solution times and solution time values currently defined
 * for the specified dataset based on the dataset's solution time clustering
 * options. The times array must be deallocated by the addon using
 * TecUtilArrayDealloc().
 * This function is \ref threadsafe.
 *
 * @since
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilSolutionTimeGetSolutionTimesByDataSetID(UniqueID_t              dataSetID,
                                                                     TP_OUT EntIndex_t*      numTimes,
                                                                     TP_ARRAY_GIVES double** times);

/**
 * Returns the solution time at the specified time step in a dataset based on
 * the dataset's solution time clustering options.
 * This function is \ref threadsafe.
 *
 * @since
 *     2017.2
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilSolutionTimeGetSolutionTimeAtTimeStepByDataSetID(UniqueID_t     dataSetID,
                                                                              EntIndex_t     timeStep,
                                                                              TP_OUT double* solutionTime);

/**
 * Get the time step at the specified solution time in a dataset based on the
 * dataset's solution time clustering options.
 * This function is \ref threadsafe.
 *
 * @since
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilSolutionTimeGetTimeStepAtSolutionTimeByDataSetID(UniqueID_t         dataSetID,
                                                                              double             solutionTime,
                                                                              TP_OUT EntIndex_t* timeStep);

/**
 * Returns the minimum and maximum solution time in a dataset based on the
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilSolutionTimeGetSolutionTimeMinMaxByDataSetID(UniqueID_t     dataSetID,
                                                                          TP_OUT double* min,
                                                                          TP_OUT double* max);
 ...
 *
 */
LINKTOADDON double TecUtilSolutionTimeGetCurrentForFrame(UniqueID_t frameID) TP_DIRECT;

/**
 * Get the current time step for the frame based on the frame's active fieldmaps
 * and the dataset's solution time clustering options.
 * This function is \ref threadsafe.
 *
 * @since
 *     2017.2
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilSolutionTimeGetCurrentTimeStepForFrame(UniqueID_t         frameID,
                                                                    TP_OUT EntIndex_t* timeStep);

/**
 * Get the number of unique solution times in the given frame based on the
 * frame's active fieldmaps and the dataset's solution time clustering options.
 * This function is \ref threadsafe.
 *
 * @since
 *     2017.2
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilSolutionTimeGetNumTimeStepsForFrame(UniqueID_t         frameID,
                                                                 TP_OUT EntIndex_t* numTimeSteps);

/**
 * Gets the number of solution times and solution time values currently defined
 * for the specified frame base on the frame's active fieldmaps and the
 * dataset's solution time clustering options. The times array must be
 * deallocated by the addon using TecUtilArrayDealloc().
 * This function is \ref threadsafe.
 *
 * @since
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilSolutionTimeGetSolutionTimesForFrame(UniqueID_t              frameID,
                                                                  TP_OUT EntIndex_t*      numTimes,
                                                                  TP_ARRAY_GIVES double** times);

/**
 * Returns the solution time at the specified time step in a frame based on the
 * frame's active fieldmaps and the dataset's solution time clustering options.
 * This function is \ref threadsafe.
 *
 * @since
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilSolutionTimeGetSolutionTimeAtTimeStepForFrame(UniqueID_t     frameID,
                                                                           EntIndex_t     timeStep,
                                                                           TP_OUT double* solutionTime);

/**
 * Returns the time step for a given solution time in a frame based on the
 * frame's active fieldmaps and the dataset's solution time clustering options.
 * This function is \ref threadsafe.
 *
 * @since
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilSolutionTimeGetTimeStepAtSolutionTimeForFrame(UniqueID_t         frameID,
                                                                           double             solutionTime,
                                                                           TP_OUT EntIndex_t* timeStep);

/**
 * Returns the minimum and maximum solution times in a frame based on the
 * frame's active fieldmaps and the dataset's solution time clustering options.
 * This function is \ref threadsafe.
 *
 * @since
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilSolutionTimeGetSolutionTimeMinMaxForFrame(UniqueID_t     frameID,
                                                                       TP_OUT double* min,
                                                                       TP_OUT double* max);
 ...
 * @ingroup DataServices
 */
LINKTOADDON OffsetDataType_e TecUtilDataFaceMapGetElementRawItemType(FaceMap_pa FaceMap) TP_DIRECT;
 ...
 * @ingroup DataServices
 */
LINKTOADDON OffsetDataType_e TecUtilDataFaceMapGetNodeRawItemType(FaceMap_pa FaceMap) TP_DIRECT;
 ...
 *
 */
LINKTOADDON LgIndex_t TecUtilDataFaceMapGetNumNodes(FaceMap_pa FaceMap) TP_DIRECT;
 ...
 *
 */
LINKTOADDON LgIndex_t TecUtilDataFaceMapGetNFaces(FaceMap_pa FaceMap) TP_DIRECT;
 ...
 *
 */
LINKTOADDON int32_t TecUtilDataFaceMapGetNFaceNodes(FaceMap_pa FaceMap,
                                                            LgIndex_t  Face) TP_DIRECT;
 ...
 * @param NodeIndex
 *     The ones based node index within the face.
 *
 * @return
 *     The desired node.
 *
 ...
 *
 */
LINKTOADDON LgIndex_t TecUtilDataFaceMapGetFaceNode(FaceMap_pa FaceMap,
                                                    LgIndex_t  Face,
                                                    int32_t    NodeIndex) TP_DIRECT;
 ...
 *
 */
LINKTOADDON LgIndex_t TecUtilDataFaceMapGetLeftElem(FaceMap_pa FaceMap,
                                                            LgIndex_t  Face) TP_DIRECT;
 ...
 *
 */
LINKTOADDON LgIndex_t TecUtilDataFaceMapGetRightElem(FaceMap_pa FaceMap,
                                                             LgIndex_t  Face) TP_DIRECT;
 ...
 *
 */
LINKTOADDON int32_t TecUtilDataFaceMapGetNBndryConns(FaceMap_pa FaceMap,
                                                             LgIndex_t  Face) TP_DIRECT;
 ...
 * @param BndryConnIndex
 *     The ones based boundary connection index for the element. This must be between
 ...
 *
 */
LINKTOADDON void TecUtilDataFaceMapGetBndryConn(FaceMap_pa         FaceMap,
                                                LgIndex_t          Face,
                                                int32_t            BndryConnIndex,
                                                TP_OUT LgIndex_t*  BndryElem,
                                                TP_OUT EntIndex_t* BndryElemZone) TP_DIRECT;
 ...
 *
 */
LINKTOADDON FaceMap_pa TecUtilDataFaceMapGetReadableRef(EntIndex_t Zone) TP_DIRECT;
 ...
 *
 */
LINKTOADDON FaceMap_pa TecUtilDataFaceMapGetWritableRef(EntIndex_t Zone) TP_DIRECT;
 ...
 * @ingroup DataServices
 */
LINKTOADDON NodeToElemMap_pa TecUtilDataNodeToElemMapGetReadableRef(EntIndex_t Zone) TP_DIRECT;
 ...
 *
 * <FortranSyntax>
 *    INTEGER*8 FUNCTION TecUtilDataNodeToElemMapGetNumElems (
 *   &           NodeToElemMapPtr,
 *   &           Node)
 *    POINTER   (NodeToElemMapPtr, NodeToElemMap)
 *    INTEGER*8 Node
 ...
 * @ingroup DataServices
 */
LINKTOADDON LgIndex_t TecUtilDataNodeToElemMapGetNumElems(NodeToElemMap_pa NodeToElemMap,
                                                          LgIndex_t        Node) TP_DIRECT;
/**
 * Gets an element, along with its section it belongs to, that is connected to the specified node.
 *
 * This function is \ref threadsafe.
 *
 * @since
 ...
 *
 * @param Node
 *   The ones based node index for which the connected element is desired.
 *
 * @param NodeElemIndex
 *   The ones based element index of the desired node element.
 *   Must be in the range [1, n], where n is the number of
 *   elements returned by TecUtilDataNodeToElemMapGetNumElems() for the
 *   specified node.
 *
 * @param Section
 *   The ones based section number to which the element belongs.
 *
 * @param Element
 *   The ones based element number connected to the specified node.
 *
 * @ingroup DataServices
 */
LINKTOADDON void TecUtilDataNodeToElemMapGetElement(NodeToElemMap_pa   NodeToElemMap,
                                                    LgIndex_t          Node,
                                                    LgIndex_t          NodeElemIndex,
                                                    TP_OUT EntIndex_t* Section,
                                                    TP_OUT LgIndex_t*  Element) TP_DIRECT;
/**
 ...
 *
 * <FortranSyntax>
 *    INTEGER*8 FUNCTION TecUtilDataNodeToElemMapGetElem (
 *   &           NodeToElemMapPtr,
 *   &           Node,
 *   &           NodeElemIndex)
 *    POINTER   (NodeToElemMapPtr, NodeToElemMap)
 *    INTEGER*8 Node
 *    INTEGER*4 NodeElemIndex
 * </FortranSyntax>
 *
 * <PythonSyntax>
 * </PythonSyntax>
 ...
 * @ingroup DataServices
 */
LINKTOADDON LgIndex_t TecUtilDataNodeToElemMapGetElem(NodeToElemMap_pa NodeToElemMap,
                                                      LgIndex_t        Node,
                                                      LgIndex_t        ElemIndex) TP_DIRECT;
 ...
 *
 */
LINKTOADDON ElemToFaceMap_pa TecUtilDataElemGetReadableRef(EntIndex_t Zone) TP_DIRECT;
 ...
 *
 */
LINKTOADDON int32_t TecUtilDataElemGetNumFaces(ElemToFaceMap_pa ElemToFaceMap,
                                                       LgIndex_t        Elem) TP_DIRECT;
 ...
 *
 * @param Elem
 *   The one based element index for which to return the number of faces.
 *
 * @param FaceIndex
 *   The ones based face index for which to return the face number.
 *   Must be in the range [1, n], where n is the number of
 ...
 *
 */
LINKTOADDON LgIndex_t TecUtilDataElemGetFace(ElemToFaceMap_pa ElemToFaceMap,
                                             LgIndex_t        Elem,
                                             ElemFaceOffset_t FaceIndex) TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilDataValueIsPassive(EntIndex_t Zone,
                                                                        EntIndex_t Var) TP_DIRECT;
 ...
 *
 */
LINKTOADDON int32_t     TecUtilGetDefaultExportImageWidth(ExportFormat_e ExportFormat,
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilGetExportFormatExtensions(ExportFormat_e  exportFormat,
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilVectorCheckVariableAssignments();
 ...
 * @ingroup Utilities
 */
LINKTOADDON TP_GIVES Set_pa TecUtilDataSetGetZonesForStrandID(EntIndex_t strandID) TP_DIRECT;
 ...
 * @ingroup Utilities
 */
LINKTOADDON TP_GIVES Set_pa TecUtilDataSetGetStrandIDs() TP_DIRECT;
 ...
 * @ingroup Utilities
 */
LINKTOADDON TP_GIVES Set_pa TecUtilDataSetGetActiveStrandIDs() TP_DIRECT;


/**
 * Returns the set of zones for a given part in a given dataset.
 *
 * @return
 *     set of zones.
 *
 ...
 *
 * @code
 *   // Get the zones in part 3
 *   UniqueID_t const datasetID = TecUtilFrameGetDataSetUniqueIDByFrameID(TecUtilFrameGetActiveID());
 *   Set_pa const parts  = TecUtilDataSetGetPartZones(datasetID,3);
 * @endcode
 *
 * @sa
 * @since 2021.1
 * @ingroup Utilities
 */
LINKTOADDON Set_pa TecUtilDataSetGetPartZones(UniqueID_t datasetID,
                                              EntIndex_t partNumber);


/**
 * Returns the part number associated with a part name.
 *
 * @return
 *     The part number.
 *
 * <FortranSyntax>
 *    INTEGER*4 FUNCTION TecUtilDataSetGetPartNumByName(
 *   &                   DataSetID,
 *   &                   PartName)
 *    INTEGER*4       DataSetID
 *    CHARACTER*(*)   PartName
 ...
 * @code
 *   UniqueID_t const datasetID = TecUtilFrameGetDataSetUniqueIDByFrameID(TecUtilFrameGetActiveID());
 *   EntIndex_t const part      = TecUtilDataSetGetPartNumByName(datasetID,"LeftWing");
 * @endcode
 *
 * @sa
 * @since 2021.1
 * @ingroup Utilities
 */
LINKTOADDON EntIndex_t TecUtilDataSetGetPartNumByName(UniqueID_t datasetID,
                                                      const char *partName);
/**
 * Returns the number of parts in a given dataset.
 *
 * @return
 *     Number of parts.
 *
 * <FortranSyntax>
 *    INTEGER*4 FUNCTION TecUtilDataSetGetNumParts(
 *   &                   DataSetID)
 *    INTEGER*4       DataSetID
 * </FortranSyntax>
 *
 ...
 * @code
 *   UniqueID_t const datasetID = TecUtilFrameGetDataSetUniqueIDByFrameID(TecUtilFrameGetActiveID());
 *   EntIndex_t const numParts  = TecUtilDataSetGetNumParts(datasetID);
 * @endcode
 *
 * @sa
 * @since 2021.1
 * @ingroup Utilities
 */
LINKTOADDON EntIndex_t TecUtilDataSetGetNumParts(UniqueID_t dataSetID);
 ...
 * @ingroup Utilities
 */
LINKTOADDON Boolean_t TecUtilExtractTimesFromFileNames(StringList_pa        fileNames,
                                                               TP_ARRAY_OUT double* times,
                                                               Boolean_t            requireAlphaTokenMatching) TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilDataValueIsLoaded(EntIndex_t Zone,
                                                       EntIndex_t Var) TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilQueryCanPlotStreamtraces() TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilQueryCanPlotVolumeStreamtraces() TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilQueryZoneCanPlotVolumeStreamtraces(EntIndex_t zone) TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilQueryZoneHasVisibleFieldStyle(EntIndex_t zone) TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilQueryCanPlotSlices() TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilQueryPlotContainsContourLines() TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilQueryContourLevelModificationsAllowed() TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilQueryOkToExtractPoints() TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilQueryOkToExtractContourLines() TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilQueryOkToExtractIsoSurfaces() TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilQueryOkToExtractSlices() TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilQueryOkToExtractStream() TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilQueryStreamtracesAreActive() TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilQueryOkToCopyPickedObjects() TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilQueryOkToPastePickedObjects() TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilQueryOkToClearPickedObjects() TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilQueryOkToPushPopPickedObjects() TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilQueryOkToAnimateZones();
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilQueryIsLayoutDirty() TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilQueryLayoutHasStyle() TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilProbeIsCallbackInstalled() TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilQueryPlotContainsSurfaceZones() TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilQueryPlotContainsPoints() TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilQueryPlotContainsVolumeZones() TP_DIRECT;


/*
 * @deprecated
 *   Please use TecUtilZoneGetDimension() instead.
 *
 * Determine the rank (dimension) of a zone.
 *   - -1: Zone metrics not loaded
 ...
 *
 */
LINKTOADDON int32_t TecUtilQueryGetZoneRank(EntIndex_t Zone) TP_DIRECT;
 ...
 *
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilQueryCanPlotIsoSurfaces() TP_DIRECT;
 ...
 * @ingroup Utilities
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilQueryIsXYDependentAllowedForFrame(UniqueID_t FrameID) TP_DIRECT;
 ...
 */
LINKTOADDON int32_t TecUtilMacroFunctionGetCount();
 ...
 */
LINKTOADDON Boolean_t TecUtilMacroFunctionGetName(int32_t         Index,
 ...
 */
LINKTOADDON char TecUtilMacroFunctionGetAcceleratorKey(int32_t Index);
 ...
 */
LINKTOADDON int32_t TecUtilColorMapGetCount();
 ...
 */
LINKTOADDON void  TecUtilColorMapGetName(int32_t ColorMapNumber, TP_GIVES char **ColorMapName);
 ...
 */
LINKTOADDON int32_t TecUtilColorMapGetNumByName(const char *ColorMapName);
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilCurveGetDisplayInfo(EntIndex_t      LineMap,
 ...
 *
  ...
  * </PythonSyntax>
  */
LINKTOADDON TP_QUERY Boolean_t TecUtilFourierTransformIsValidZone(EntIndex_t zoneNum) TP_DIRECT;
  ...
  * </PythonSyntax>
  */
LINKTOADDON TP_QUERY Boolean_t TecUtilFourierTransformIsValidZoneByDataSetID(UniqueID_t datasetID,
                                                                                     EntIndex_t zoneNum) TP_DIRECT;
 ...
 * </PythonSyntax>
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilPickIsSnapToPaperAllowed() TP_DIRECT;
...
* </PythonSyntax>
*/
LINKTOADDON TP_QUERY Boolean_t TecUtilPickIsSnapToGridAllowed() TP_DIRECT;
 ...
 * @ingroup Utilities
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilQueryOkToAnimateIJKPlanes();
 ...
 * @ingroup Utilities
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilQueryOkToSmooth() TP_DIRECT;
 ...
 * @ingroup Utilities
 */
LINKTOADDON TP_QUERY Boolean_t TecUtilQueryIsTechnologyPreviewFeatureEnabled(const char* Feature) TP_DIRECT;
...
LINKTOADDON int32_t TecUtilGetExportImageHeight(int32_t        width,
                                                               ExportRegion_e region) TP_DIRECT;
 ...
 * @ingroup Export
 */
LINKTOADDON void TecUtilGetExportImageWidthAndHeight(ExportRegion_e      exportRegion,
                                                             ExportFormat_e      exportFormat,
                                                             TP_IN_OUT int32_t*  width,
                                                             TP_OUT int32_t*     height) TP_DIRECT;
/**
 ...
 */
LINKTOADDON MessageBoxType_e TecUtilLastErrorMessageType();

LINKTOADDON int64_t TecUtilElapseTimeInMS() TP_DIRECT;

/*
 * No Doxygen, see DIAG.h
 */
LINKTOADDON ArbParam_t TecUtilInternalDiagGetInfo(int32_t getWhat) TP_DIRECT;

/*
 * No Doxygen, Internal use only.
 */
LINKTOADDON Boolean_t TecUtilInternalIsPrintDebugOn() TP_DIRECT;

/**
 * Returns the number of linear and high-order nodes per cell. The number of linear nodes is
 * equivalent to the number of cell corners. If the grid order is 1 the number of high-order
 * nodes is zero.
 *
 * @param cellShape
 *     FE cell shape for which the number of nodes is desired.
 * @param gridOrder
 *     Cell grid order.
 * @param basisFn
 *     Specifies the basis function used for grid orders greater than 1.
 *     Currently only FECellBasisFunction_Lagrangian is allowed.
 * @param numCornerNodes
 *     Resulting number of linear, or corner, nodes per cell.
 * @param numNodes
 *     Resulting number of nodes per cell. For high-order cell types this value is larger than
 *     numCornerNodes, otherwise, for cell types with grid order 1 it is the same.
 *
 * @since
 *     2023.1
 *
 * @ingroup DataServices
 */
LINKTOADDON void TecUtilFECellTypeGetNumNodes(FECellShape_e         cellShape,
                                              EntIndex_t            gridOrder,
                                              FECellBasisFunction_e basisFn,
                                              TP_OUT EntIndex_t*    numCornerNodes,
                                              TP_OUT EntIndex_t*    numNodes) TP_DIRECT;
