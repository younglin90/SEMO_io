#ifndef TECPLOT_tecutildataio_utils_EXPORTS_H
#define TECPLOT_tecutildataio_utils_EXPORTS_H
...
#if defined _WIN32
    #define tecutildataio_utils_HELPER_DLL_IMPORT __declspec(dllimport)
    #define tecutildataio_utils_HELPER_DLL_EXPORT __declspec(dllexport)
    #define tecutildataio_utils_HELPER_DLL_LOCAL
#else
    #if __GNUC__ >= 4
        #define tecutildataio_utils_HELPER_DLL_IMPORT __attribute__ ((visibility("default")))
        #define tecutildataio_utils_HELPER_DLL_EXPORT __attribute__ ((visibility("default")))
        #define tecutildataio_utils_HELPER_DLL_LOCAL  __attribute__ ((visibility("hidden")))
    #else
        #define tecutildataio_utils_HELPER_DLL_IMPORT
        #define tecutildataio_utils_HELPER_DLL_EXPORT
        #define tecutildataio_utils_HELPER_DLL_LOCAL
    #endif
#endif
 ...
 */
#ifdef tecutildataio_utils_EXPORTS // defined if we are building the tecutildataio_utils code (instead of using it)
  #define tecutildataio_utils_API tecutildataio_utils_HELPER_DLL_EXPORT
#else
  #define tecutildataio_utils_API tecutildataio_utils_HELPER_DLL_IMPORT
#endif // tecutildataio_utils_EXPORTS
#define tecutildataio_utils_LOCAL tecutildataio_utils_HELPER_DLL_LOCAL
 ...
 */
#if defined _WIN32
    #define tecutildataio_utils_FORCE_EXPORT(ClassName) class tecutildataio_utils_API ClassName
#else
    #define tecutildataio_utils_FORCE_EXPORT(ClassName)
#endif
