 ...
 *
 */
LINKTOADDON SetValueReturnCode_e TecUtilFrameSetPosAndSize(double X,
                                                                   double Y,
                                                                   double Width,
                                                                   double Height);
 ...
 */
LINKTOADDON ArbParam_t TecUtilStyleValueGetMacroID(const char* StyleValueName) TP_DIRECT;
 ...
 *
 */
LINKTOADDON SetValueReturnCode_e TecUtilStyleSetLowLevelX(ArgList_pa ArgList);
 ...
 *
 */
LINKTOADDON SetValueReturnCode_e TecUtilStyleSetLowLevel(Widget       TextFieldWidget,
                                                                 double       DValue,
                                                                 ArbParam_t   IValue,
 ...
 */
LINKTOADDON SetValueReturnCode_e TecUtilFrameSetMode(FrameMode_e NewFrameMode);
 ...
 *
 */
LINKTOADDON SetValueReturnCode_e TecUtilFrameSetPlotType(PlotType_e NewPlotType);
 ...
 * @ingroup FrameManagement
 */
LINKTOADDON Boolean_t TecUtilFrameSetDataSet(UniqueID_t sourceDataSetID,
 ...
 *
 */
LINKTOADDON SetValueReturnCode_e TecUtilFrameSetName(const char *Name);
 ...
 *
 */
LINKTOADDON SetValueReturnCode_e TecUtilPageSetName(const char *Name);
 ...
 * @ingroup Zone
 */
LINKTOADDON void TecUtilZoneSolutionTimeModificationBegin();
 ...
 * @ingroup Zone
 */
LINKTOADDON void TecUtilZoneSolutionTimeModificationEnd();
 ...
 *
 */
LINKTOADDON SetValueReturnCode_e TecUtilZoneSetSolutionTime(EntIndex_t Zone,
                                                                    double     SolutionTime);
 ...
 *
 */
LINKTOADDON SetValueReturnCode_e TecUtilZoneSetActive(Set_pa     ZoneSet,
                                                              AssignOp_e AssignModifier);
 ...
 *
 */
LINKTOADDON void TecUtilZoneStyleApplyAuto(Set_pa ZoneSet);
 ...
 *
 */
LINKTOADDON SetValueReturnCode_e TecUtilFieldMapSetActive(Set_pa     FieldMapSet,
                                                                  AssignOp_e AssignModifier);
 ...
 * #internalattributes exclude_python, exclude_sdkdoc
 */
LINKTOADDON SetValueReturnCode_e TecUtilXYMapSetActive(Set_pa     XYMapSet,
                                                               AssignOp_e AssignModifier);
 ...
 *
 */
LINKTOADDON SetValueReturnCode_e TecUtilLineMapSetActive(Set_pa     LineMapSet,
                                                                 AssignOp_e AssignModifier);
 ...
 * #internalattributes exclude_python, exclude_sdkdoc
 */
LINKTOADDON SetValueReturnCode_e TecUtilFieldSetLayer(const char *LayerShowFlag,
 ...
 *
 */
LINKTOADDON SetValueReturnCode_e TecUtilFieldLayerSetIsActive(const char *LayerShowFlag,
                                                                      Boolean_t   TurnOnFieldLayer);
 ...
 * #internalattributes exclude_python, exclude_sdkdoc
 */
LINKTOADDON SetValueReturnCode_e TecUtilXYSetLayer(const char *LayerShowFlag,
 ...
 *
 */
LINKTOADDON SetValueReturnCode_e TecUtilLinePlotLayerSetIsActive(const char *LayerShowFlag,
 ...
 *
 */
LINKTOADDON SetValueReturnCode_e TecUtilContourSetVariableX(ArgList_pa ArgList);
 ...
 *
 */
LINKTOADDON SetValueReturnCode_e TecUtilContourSetVariable(EntIndex_t NewVariable);
 ...
 *
 */
LINKTOADDON SetValueReturnCode_e TecUtilZoneSetMesh(const char *Attribute,
                                                            Set_pa      ZoneSet,
                                                            double      DValue,
                                                            ArbParam_t  IValue);
 ...
 *
 */
LINKTOADDON SetValueReturnCode_e TecUtilZoneSetContour(const char *Attribute,
                                                               Set_pa      ZoneSet,
                                                               double      DValue,
                                                               ArbParam_t  IValue);
 ...
 *
 */
LINKTOADDON SetValueReturnCode_e TecUtilZoneSetVector(const char *Attribute,
                                                              Set_pa      ZoneSet,
                                                              double      DValue,
                                                              ArbParam_t  IValue);
 ...
 *
 */
LINKTOADDON SetValueReturnCode_e TecUtilZoneSetVectorIJKSkip(const char *Attribute,
                                                                     Set_pa      ZoneSet,
                                                                     LgIndex_t   Skip);
/**
 ...
 *
 */
LINKTOADDON SetValueReturnCode_e TecUtilZoneSetScatter(const char *Attribute,
                                                               Set_pa      ZoneSet,
                                                               double      DValue,
                                                               ArbParam_t  IValue);
 ...
 *
 */
LINKTOADDON SetValueReturnCode_e TecUtilZoneSetScatterIJKSkip(const char *Attribute,
                                                                      Set_pa      ZoneSet,
                                                                      LgIndex_t   Skip);
 ...
 *
 */
LINKTOADDON SetValueReturnCode_e TecUtilZoneSetScatterSymbolShape(const char *Attribute,
                                                                          Set_pa      ZoneSet,
                                                                          ArbParam_t  IValue);
 ...
 *
 */
LINKTOADDON SetValueReturnCode_e TecUtilZoneSetShade(const char *Attribute,
                                                             Set_pa      ZoneSet,
                                                             double      DValue,
                                                             ArbParam_t  IValue);
 ...
 * #internalattributes exclude_python, exclude_sdkdoc
 */
LINKTOADDON SetValueReturnCode_e TecUtilZoneSetBoundary(const char *Attribute,
                                                                Set_pa      ZoneSet,
                                                                double      DValue,
                                                                ArbParam_t  IValue);
 ...
 *
 */
LINKTOADDON SetValueReturnCode_e TecUtilZoneSetEdgeLayer(const char *Attribute,
                                                                 Set_pa      ZoneSet,
                                                                 double      DValue,
                                                                 ArbParam_t  IValue);
 ...
 *
 */
LINKTOADDON SetValueReturnCode_e TecUtilZoneSetVolumeMode(const char *Attribute,
 ...
 * #internalattributes exclude_python, exclude_sdkdoc
 */
LINKTOADDON SetValueReturnCode_e TecUtilZoneSetIJKMode(const char *Attribute,
                                                               const char *SubAttribute,
                                                               Set_pa      ZoneSet,
                                                               ArbParam_t  IValue);
 ...
 * #internalattributes exclude_python, exclude_sdkdoc
 */
LINKTOADDON SetValueReturnCode_e TecUtilXYMapSetName(Set_pa      XYMapSet,
                                                             const char *NewName);
/**
 ...
 *
 */
LINKTOADDON SetValueReturnCode_e TecUtilLineMapSetName(Set_pa      LineMapSet,
                                                               const char *NewName);
 ...
 * #internalattributes exclude_python, exclude_sdkdoc
 */
LINKTOADDON SetValueReturnCode_e TecUtilXYMapSetAssignment(const char *Attribute,
                                                                   Set_pa      XYMapSet,
                                                                   double      DValue,
                                                                   ArbParam_t  IValue);
/**
 ...
 *
 */
LINKTOADDON SetValueReturnCode_e TecUtilLineMapSetAssignment(const char *Attribute,
                                                                     Set_pa      LineMapSet,
                                                                     double      DValue,
                                                                     ArbParam_t  IValue);
 ...
 * #internalattributes exclude_python, exclude_sdkdoc
 */
LINKTOADDON SetValueReturnCode_e TecUtilXYMapSetLine(const char *Attribute,
                                                             Set_pa      XYMapSet,
                                                             double      DValue,
                                                             ArbParam_t  IValue);
/**
 ...
 *
 */
LINKTOADDON SetValueReturnCode_e TecUtilLineMapSetLine(const char *Attribute,
                                                               Set_pa      LineMapSet,
                                                               double      DValue,
                                                               ArbParam_t  IValue);
 ...
 * #internalattributes exclude_python, exclude_sdkdoc
 */
LINKTOADDON SetValueReturnCode_e TecUtilXYMapSetCurve(const char *Attribute,
                                                              Set_pa      XYMapSet,
                                                              double      DValue,
                                                              ArbParam_t  IValue);
/**
 ...
 *
 */
LINKTOADDON SetValueReturnCode_e TecUtilLineMapSetCurve(const char *Attribute,
                                                                Set_pa      LineMapSet,
                                                                double      DValue,
                                                                ArbParam_t  IValue);
 ...
 * #internalattributes exclude_python, exclude_sdkdoc
 */
LINKTOADDON SetValueReturnCode_e TecUtilXYMapSetSymbol(const char *Attribute,
                                                               Set_pa      XYMapSet,
                                                               double      DValue,
                                                               ArbParam_t  IValue);
/**
 ...
 *
 */
LINKTOADDON SetValueReturnCode_e TecUtilLineMapSetSymbol(const char *Attribute,
                                                                 Set_pa      LineMapSet,
                                                                 double      DValue,
                                                                 ArbParam_t  IValue);
 ...
 * #internalattributes exclude_python, exclude_sdkdoc
 */
LINKTOADDON SetValueReturnCode_e TecUtilXYMapSetSymbolShape(const char *Attribute,
                                                                    Set_pa      XYMapSet,
                                                                    ArbParam_t  IValue);
/**
 ...
 *
 */
LINKTOADDON SetValueReturnCode_e TecUtilLineMapSetSymbolShape(const char *Attribute,
                                                                      Set_pa      LineMapSet,
                                                                      ArbParam_t  IValue);
 ...
 * #internalattributes exclude_python, exclude_sdkdoc
 */
LINKTOADDON SetValueReturnCode_e TecUtilXYMapSetBarChart(const char *Attribute,
                                                                 Set_pa      XYMapSet,
                                                                 double      DValue,
                                                                 ArbParam_t  IValue);
/**
 ...
 *
 */
LINKTOADDON SetValueReturnCode_e TecUtilLineMapSetBarChart(const char *Attribute,
                                                                   Set_pa      LineMapSet,
                                                                   double      DValue,
                                                                   ArbParam_t  IValue);
 ...
 * #internalattributes exclude_python, exclude_sdkdoc
 */
LINKTOADDON SetValueReturnCode_e TecUtilXYMapSetErrorBar(const char *Attribute,
                                                                 Set_pa      XYMapSet,
                                                                 double      DValue,
                                                                 ArbParam_t  IValue);
/**
 ...
 *
 */
LINKTOADDON SetValueReturnCode_e TecUtilLineMapSetErrorBar(const char *Attribute,
                                                                   Set_pa      LineMapSet,
                                                                   double      DValue,
                                                                   ArbParam_t  IValue);
 ...
 * #internalattributes exclude_python, exclude_sdkdoc
 */
LINKTOADDON SetValueReturnCode_e TecUtilXYMapSetIndices(const char *Attribute,
                                                                const char *SubAttribute,
                                                                Set_pa      XYMapSet,
                                                                ArbParam_t  IValue);
/**
 ...
 *
 */
LINKTOADDON SetValueReturnCode_e TecUtilLineMapSetIndices(const char *Attribute,
                                                                  const char *SubAttribute,
                                                                  Set_pa      LineMapSet,
                                                                  ArbParam_t  IValue);
 ...
 *
 */
LINKTOADDON SetValueReturnCode_e TecUtilCurveSetExtendedSettings(EntIndex_t  LineMapNum,
                                                                         const char *Settings);
 ...
 *
 */
LINKTOADDON SetValueReturnCode_e TecUtilPrintSetup(const char *Attribute,
                                                           const char *SubAttribute,
                                                           double      DValue,
                                                           ArbParam_t  IValue);
 ...
 *
 */
LINKTOADDON SetValueReturnCode_e TecUtilExportSetup(const char *Attribute,
                                                            const char *SubAttribute,
                                                            double      DValue,
                                                            ArbParam_t  IValue);
/**
 ...
 * #internalattributes exclude_python, exclude_sdkdoc
 */
LINKTOADDON SetValueReturnCode_e TecUtilFrameSetLinking(const char  *Attribute,
                                                                ArbParam_t   IValue);
/**
 ...
 *
 */
LINKTOADDON SetValueReturnCode_e TecUtilLinkingSetValue(const char  *Attribute,
                                                                const char  *SubAttribute,
                                                                ArbParam_t   IValue);
 ...
 *
 */
LINKTOADDON void TecUtilColorMapRefresh();
 ...
 *
 */
LINKTOADDON SetValueReturnCode_e TecUtilColorMapSetBase(ContourColorMap_e BaseColorMap);
 ...
 *
 */
LINKTOADDON SetValueReturnCode_e TecUtilSolutionTimeSetCurrent(double NewSolutionTime);
 ...
 * #internalattributes exclude_python, exclude_sdkdoc
 */
LINKTOADDON void TecUtilDialogSetLaunchPosition(Widget            W,
                                                        int32_t           DialogWidth,
 ...
 *
 */
LINKTOADDON SetValueReturnCode_e TecUtilZoneSetStrandID(EntIndex_t Zone,
                                                                EntIndex_t StrandID);
 ...
 *
 */
LINKTOADDON SetValueReturnCode_e TecUtilZoneSetStrandIDByDataSetID(UniqueID_t dataSetID,
                                                                           EntIndex_t zone,
                                                                           EntIndex_t strandID);
 ...
 *
 */
LINKTOADDON Boolean_t TecUtilDataSetAutoAssignStrandIDs(Set_pa ZoneSet) TP_DIRECT;
#endif
