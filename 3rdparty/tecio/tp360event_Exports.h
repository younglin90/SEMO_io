#ifndef TECPLOT_tp360event_EXPORTS_H
#define TECPLOT_tp360event_EXPORTS_H
...
#if defined _WIN32
    #define tp360event_HELPER_DLL_IMPORT __declspec(dllimport)
    #define tp360event_HELPER_DLL_EXPORT __declspec(dllexport)
    #define tp360event_HELPER_DLL_LOCAL
#else
    #if __GNUC__ >= 4
        #define tp360event_HELPER_DLL_IMPORT __attribute__ ((visibility("default")))
        #define tp360event_HELPER_DLL_EXPORT __attribute__ ((visibility("default")))
        #define tp360event_HELPER_DLL_LOCAL  __attribute__ ((visibility("hidden")))
    #else
        #define tp360event_HELPER_DLL_IMPORT
        #define tp360event_HELPER_DLL_EXPORT
        #define tp360event_HELPER_DLL_LOCAL
    #endif
#endif
 ...
 */
#ifdef tp360event_EXPORTS // defined if we are building the tp360event code (instead of using it)
  #define tp360event_API tp360event_HELPER_DLL_EXPORT
#else
  #define tp360event_API tp360event_HELPER_DLL_IMPORT
#endif // tp360event_EXPORTS
#define tp360event_LOCAL tp360event_HELPER_DLL_LOCAL
 ...
 */
#if defined _WIN32
    #define tp360event_FORCE_EXPORT(ClassName) class tp360event_API ClassName
#else
    #define tp360event_FORCE_EXPORT(ClassName)
#endif
